...
_main()
{
 ...
 134:	27c080e7          	jalr	636(ra) # 3ac <exit>
...
gets(char *buf, int max)
{
 ...
 226:	1a2080e7          	jalr	418(ra) # 3c4 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 278:	178080e7          	jalr	376(ra) # 3ec <open>
  if(fd < 0)
 ...
 288:	180080e7          	jalr	384(ra) # 404 <fstat>
 28c:	892a                	mv	s2,a0
  close(fd);
 28e:	8526                	mv	a0,s1
 290:	00000097          	auipc	ra,0x0
 294:	144080e7          	jalr	324(ra) # 3d4 <close>
  return r;
}
 298:	854a                	mv	a0,s2
