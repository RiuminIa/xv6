...
go(int which_child)
{
  ...
  char *break0 = sbrk(0);
      ...
      94:	e2e080e7          	jalr	-466(ra) # ebe <sbrk>
      98:	8aaa                	mv	s5,a0
  uint64 iters = 0;
  ...
  mkdir("grindir");
      ...
      a6:	dfc080e7          	jalr	-516(ra) # e9e <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	29650513          	addi	a0,a0,662 # 1340 <malloc+0xea>
      b2:	00001097          	auipc	ra,0x1
      b6:	df4080e7          	jalr	-524(ra) # ea6 <chdir>
    ...
    exit(1);
      ...
      d2:	d68080e7          	jalr	-664(ra) # e36 <exit>
  }
  chdir("/");
      d6:	00001517          	auipc	a0,0x1
      da:	29250513          	addi	a0,a0,658 # 1368 <malloc+0x112>
      de:	00001097          	auipc	ra,0x1
      e2:	dc8080e7          	jalr	-568(ra) # ea6 <chdir>
  ...
  int fd = -1;
    ...
    if(what == 1){
     ...
     116:	d64080e7          	jalr	-668(ra) # e76 <open>
     11a:	00001097          	auipc	ra,0x1
     11e:	d44080e7          	jalr	-700(ra) # e5e <close>
    iters++;
    ...
    if((iters % 500) == 0)
     ...
     138:	d22080e7          	jalr	-734(ra) # e56 <write>
    int what = rand() % 23;
    ...
    if(what == 1){
     ...
     170:	d0a080e7          	jalr	-758(ra) # e76 <open>
     174:	00001097          	auipc	ra,0x1
     178:	cea080e7          	jalr	-790(ra) # e5e <close>
     ...
     18a:	d00080e7          	jalr	-768(ra) # e86 <unlink>
     ...
     19c:	d0e080e7          	jalr	-754(ra) # ea6 <chdir>
     ...
     1ae:	cdc080e7          	jalr	-804(ra) # e86 <unlink>
      chdir("/");
     1b2:	00001517          	auipc	a0,0x1
     1b6:	1b650513          	addi	a0,a0,438 # 1368 <malloc+0x112>
     1ba:	00001097          	auipc	ra,0x1
     1be:	cec080e7          	jalr	-788(ra) # ea6 <chdir>
     ...
     1da:	c60080e7          	jalr	-928(ra) # e36 <exit>
    } else if(what == 5){
      close(fd);
     1de:	8552                	mv	a0,s4
     1e0:	00001097          	auipc	ra,0x1
     1e4:	c7e080e7          	jalr	-898(ra) # e5e <close>
      fd = open("/grindir/../a", O_CREATE|O_RDWR);
     1e8:	20200593          	li	a1,514
     1ec:	00001517          	auipc	a0,0x1
     1f0:	1c450513          	addi	a0,a0,452 # 13b0 <malloc+0x15a>
     1f4:	00001097          	auipc	ra,0x1
     1f8:	c82080e7          	jalr	-894(ra) # e76 <open>
     1fc:	8a2a                	mv	s4,a0
     ...
     234:	c26080e7          	jalr	-986(ra) # e56 <write>
     ...
     24c:	c06080e7          	jalr	-1018(ra) # e4e <read>
     ...
     2da:	bb0080e7          	jalr	-1104(ra) # e86 <unlink>
      link("../grindir/./../a", "../b");
     ...
     2f2:	ba8080e7          	jalr	-1112(ra) # e96 <link>
     ...
     304:	b86080e7          	jalr	-1146(ra) # e86 <unlink>
      link(".././b", "/grindir/../a");
     ...
     31c:	b7e080e7          	jalr	-1154(ra) # e96 <link>
     320:	b509                	j	122 <go+0xaa>
    } else if(what == 13){
      int pid = fork();
     322:	00001097          	auipc	ra,0x1
     326:	b0c080e7          	jalr	-1268(ra) # e2e <fork>
      if(pid == 0){
     ...
     336:	b0c080e7          	jalr	-1268(ra) # e3e <wait>
     33a:	b3e5                	j	122 <go+0xaa>
        exit(0);
     33c:	00001097          	auipc	ra,0x1
     340:	afa080e7          	jalr	-1286(ra) # e36 <exit>
        printf("grind: fork failed\n");
     ...
     35a:	ae0080e7          	jalr	-1312(ra) # e36 <exit>
    } else if(what == 14){
      int pid = fork();
     35e:	00001097          	auipc	ra,0x1
     362:	ad0080e7          	jalr	-1328(ra) # e2e <fork>
      if(pid == 0){
     ...
     372:	ad0080e7          	jalr	-1328(ra) # e3e <wait>
     376:	b375                	j	122 <go+0xaa>
        fork();
     378:	00001097          	auipc	ra,0x1
     37c:	ab6080e7          	jalr	-1354(ra) # e2e <fork>
        fork();
     380:	00001097          	auipc	ra,0x1
     384:	aae080e7          	jalr	-1362(ra) # e2e <fork>
        exit(0);
     388:	4501                	li	a0,0
     38a:	00001097          	auipc	ra,0x1
     38e:	aac080e7          	jalr	-1364(ra) # e36 <exit>
        printf("grind: fork failed\n");
     ...
     3a8:	a92080e7          	jalr	-1390(ra) # e36 <exit>
    } else if(what == 15){
      sbrk(6011);
     3ac:	6505                	lui	a0,0x1
     3ae:	77b50513          	addi	a0,a0,1915 # 177b <digits+0x93>
     3b2:	00001097          	auipc	ra,0x1
     3b6:	b0c080e7          	jalr	-1268(ra) # ebe <sbrk>
     3ba:	b3a5                	j	122 <go+0xaa>
    } else if(what == 16){
      if(sbrk(0) > break0)
     3bc:	4501                	li	a0,0
     3be:	00001097          	auipc	ra,0x1
     3c2:	b00080e7          	jalr	-1280(ra) # ebe <sbrk>
     3c6:	d4aafee3          	bgeu	s5,a0,122 <go+0xaa>
        sbrk(-(sbrk(0) - break0));
     3ca:	4501                	li	a0,0
     3cc:	00001097          	auipc	ra,0x1
     3d0:	af2080e7          	jalr	-1294(ra) # ebe <sbrk>
     3d4:	40aa853b          	subw	a0,s5,a0
     3d8:	00001097          	auipc	ra,0x1
     3dc:	ae6080e7          	jalr	-1306(ra) # ebe <sbrk>
     3e0:	b389                	j	122 <go+0xaa>
    } else if(what == 17){
      int pid = fork();
     3e2:	00001097          	auipc	ra,0x1
     3e6:	a4c080e7          	jalr	-1460(ra) # e2e <fork>
     3ea:	8b2a                	mv	s6,a0
      if(pid == 0){
     ...
     3fe:	aac080e7          	jalr	-1364(ra) # ea6 <chdir>
     ...
     40a:	a60080e7          	jalr	-1440(ra) # e66 <kill>
      wait(0);
     40e:	4501                	li	a0,0
     410:	00001097          	auipc	ra,0x1
     414:	a2e080e7          	jalr	-1490(ra) # e3e <wait>
     ...
     42a:	a50080e7          	jalr	-1456(ra) # e76 <open>
     42e:	00001097          	auipc	ra,0x1
     432:	a30080e7          	jalr	-1488(ra) # e5e <close>
        exit(0);
     436:	4501                	li	a0,0
     438:	00001097          	auipc	ra,0x1
     43c:	9fe080e7          	jalr	-1538(ra) # e36 <exit>
        printf("grind: fork failed\n");
     ...
     456:	9e4080e7          	jalr	-1564(ra) # e36 <exit>
        printf("grind: chdir failed\n");
     ...
     470:	9ca080e7          	jalr	-1590(ra) # e36 <exit>
    } else if(what == 18){
      int pid = fork();
     474:	00001097          	auipc	ra,0x1
     478:	9ba080e7          	jalr	-1606(ra) # e2e <fork>
      if(pid == 0){
     ...
     488:	9ba080e7          	jalr	-1606(ra) # e3e <wait>
     48c:	b959                	j	122 <go+0xaa>
        kill(getpid());
     48e:	00001097          	auipc	ra,0x1
     492:	a28080e7          	jalr	-1496(ra) # eb6 <getpid>
     496:	00001097          	auipc	ra,0x1
     49a:	9d0080e7          	jalr	-1584(ra) # e66 <kill>
        exit(0);
     49e:	4501                	li	a0,0
     4a0:	00001097          	auipc	ra,0x1
     4a4:	996080e7          	jalr	-1642(ra) # e36 <exit>
        printf("grind: fork failed\n");
     ...
     4be:	97c080e7          	jalr	-1668(ra) # e36 <exit>
    } else if(what == 19){
      int fds[2];
      if(pipe(fds) < 0){
     4c2:	fa840513          	addi	a0,s0,-88
     4c6:	00001097          	auipc	ra,0x1
     4ca:	980080e7          	jalr	-1664(ra) # e46 <pipe>
     ...
     4d6:	95c080e7          	jalr	-1700(ra) # e2e <fork>
      if(pid == 0){
     ...
     4e8:	97a080e7          	jalr	-1670(ra) # e5e <close>
      close(fds[1]);
     4ec:	fac42503          	lw	a0,-84(s0)
     4f0:	00001097          	auipc	ra,0x1
     4f4:	96e080e7          	jalr	-1682(ra) # e5e <close>
      wait(0);
     4f8:	4501                	li	a0,0
     4fa:	00001097          	auipc	ra,0x1
     4fe:	944080e7          	jalr	-1724(ra) # e3e <wait>
     ...
     51a:	920080e7          	jalr	-1760(ra) # e36 <exit>
        fork();
     51e:	00001097          	auipc	ra,0x1
     522:	910080e7          	jalr	-1776(ra) # e2e <fork>
        fork();
     526:	00001097          	auipc	ra,0x1
     52a:	908080e7          	jalr	-1784(ra) # e2e <fork>
     ...
     540:	91a080e7          	jalr	-1766(ra) # e56 <write>
     544:	4785                	li	a5,1
     ...
     558:	8fa080e7          	jalr	-1798(ra) # e4e <read>
     55c:	4785                	li	a5,1
     55e:	02f51063          	bne	a0,a5,57e <go+0x506>
        exit(0);
     562:	4501                	li	a0,0
     564:	00001097          	auipc	ra,0x1
     568:	8d2080e7          	jalr	-1838(ra) # e36 <exit>
          printf("grind: pipe write failed\n");
     ...
     5a6:	894080e7          	jalr	-1900(ra) # e36 <exit>
    } else if(what == 20){
      int pid = fork();
     5aa:	00001097          	auipc	ra,0x1
     5ae:	884080e7          	jalr	-1916(ra) # e2e <fork>
      if(pid == 0){
     ...
     66c:	80e080e7          	jalr	-2034(ra) # e76 <open>
     670:	8b2a                	mv	s6,a0
      if(fd1 < 0){
     ...
     684:	7d6080e7          	jalr	2006(ra) # e56 <write>
     688:	4785                	li	a5,1
     ...
     698:	7fa080e7          	jalr	2042(ra) # e8e <fstat>
     ...
     6e6:	754080e7          	jalr	1876(ra) # e36 <exit>
        printf("grind: write c failed\n");
     ...
     700:	73a080e7          	jalr	1850(ra) # e36 <exit>
        printf("grind: fstat failed\n");
     ...
     71a:	720080e7          	jalr	1824(ra) # e36 <exit>
        printf("grind: fstat reports wrong size %d\n", (int)st.size);
     ...
     736:	704080e7          	jalr	1796(ra) # e36 <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     ...
     750:	6ea080e7          	jalr	1770(ra) # e36 <exit>
    } else if(what == 22){
      // echo hi | cat
      int aa[2], bb[2];
      if(pipe(aa) < 0){
     ...
     75c:	6ee080e7          	jalr	1774(ra) # e46 <pipe>
     ...
     76c:	6de080e7          	jalr	1758(ra) # e46 <pipe>
     ...
     778:	6ba080e7          	jalr	1722(ra) # e2e <fork>
      if(pid1 == 0){
     ...
     788:	6aa080e7          	jalr	1706(ra) # e2e <fork>
      if(pid2 == 0){
     ...
     79c:	6c6080e7          	jalr	1734(ra) # e5e <close>
      close(aa[1]);
     7a0:	f9c42503          	lw	a0,-100(s0)
     7a4:	00000097          	auipc	ra,0x0
     7a8:	6ba080e7          	jalr	1722(ra) # e5e <close>
      close(bb[1]);
     7ac:	fa442503          	lw	a0,-92(s0)
     7b0:	00000097          	auipc	ra,0x0
     7b4:	6ae080e7          	jalr	1710(ra) # e5e <close>
      char buf[4] = { 0, 0, 0, 0 };
     ...
     7ca:	688080e7          	jalr	1672(ra) # e4e <read>
      read(bb[0], buf+1, 1);
     7ce:	4605                	li	a2,1
     7d0:	f9140593          	addi	a1,s0,-111
     7d4:	fa042503          	lw	a0,-96(s0)
     7d8:	00000097          	auipc	ra,0x0
     7dc:	676080e7          	jalr	1654(ra) # e4e <read>
      read(bb[0], buf+2, 1);
     7e0:	4605                	li	a2,1
     7e2:	f9240593          	addi	a1,s0,-110
     7e6:	fa042503          	lw	a0,-96(s0)
     7ea:	00000097          	auipc	ra,0x0
     7ee:	664080e7          	jalr	1636(ra) # e4e <read>
      close(bb[0]);
     7f2:	fa042503          	lw	a0,-96(s0)
     7f6:	00000097          	auipc	ra,0x0
     7fa:	668080e7          	jalr	1640(ra) # e5e <close>
      int st1, st2;
      wait(&st1);
     7fe:	f9440513          	addi	a0,s0,-108
     802:	00000097          	auipc	ra,0x0
     806:	63c080e7          	jalr	1596(ra) # e3e <wait>
      wait(&st2);
     80a:	fa840513          	addi	a0,s0,-88
     80e:	00000097          	auipc	ra,0x0
     812:	630080e7          	jalr	1584(ra) # e3e <wait>
     ...
     85c:	5de080e7          	jalr	1502(ra) # e36 <exit>
        fprintf(2, "grind: pipe failed\n");
     ...
     878:	5c2080e7          	jalr	1474(ra) # e36 <exit>
        fprintf(2, "grind: pipe failed\n");
     ...
     894:	5a6080e7          	jalr	1446(ra) # e36 <exit>
        close(bb[0]);
     898:	fa042503          	lw	a0,-96(s0)
     89c:	00000097          	auipc	ra,0x0
     8a0:	5c2080e7          	jalr	1474(ra) # e5e <close>
        close(bb[1]);
     8a4:	fa442503          	lw	a0,-92(s0)
     8a8:	00000097          	auipc	ra,0x0
     8ac:	5b6080e7          	jalr	1462(ra) # e5e <close>
        close(aa[0]);
     8b0:	f9842503          	lw	a0,-104(s0)
     8b4:	00000097          	auipc	ra,0x0
     8b8:	5aa080e7          	jalr	1450(ra) # e5e <close>
        close(1);
     8bc:	4505                	li	a0,1
     8be:	00000097          	auipc	ra,0x0
     8c2:	5a0080e7          	jalr	1440(ra) # e5e <close>
        if(dup(aa[1]) != 1){
     8c6:	f9c42503          	lw	a0,-100(s0)
     8ca:	00000097          	auipc	ra,0x0
     8ce:	5e4080e7          	jalr	1508(ra) # eae <dup>
     8d2:	4785                	li	a5,1
     ...
     8f0:	54a080e7          	jalr	1354(ra) # e36 <exit>
        close(aa[1]);
     8f4:	f9c42503          	lw	a0,-100(s0)
     8f8:	00000097          	auipc	ra,0x0
     8fc:	566080e7          	jalr	1382(ra) # e5e <close>
        char *args[3] = { "echo", "hi", 0 };
     ...
     92c:	546080e7          	jalr	1350(ra) # e6e <exec>
        fprintf(2, "grind: echo: not found\n");
     ...
     948:	4f2080e7          	jalr	1266(ra) # e36 <exit>
        fprintf(2, "grind: fork failed\n");
     ...
     964:	4d6080e7          	jalr	1238(ra) # e36 <exit>
        close(aa[1]);
     968:	f9c42503          	lw	a0,-100(s0)
     96c:	00000097          	auipc	ra,0x0
     970:	4f2080e7          	jalr	1266(ra) # e5e <close>
        close(bb[0]);
     974:	fa042503          	lw	a0,-96(s0)
     978:	00000097          	auipc	ra,0x0
     97c:	4e6080e7          	jalr	1254(ra) # e5e <close>
        close(0);
     980:	4501                	li	a0,0
     982:	00000097          	auipc	ra,0x0
     986:	4dc080e7          	jalr	1244(ra) # e5e <close>
        if(dup(aa[0]) != 0){
     98a:	f9842503          	lw	a0,-104(s0)
     98e:	00000097          	auipc	ra,0x0
     992:	520080e7          	jalr	1312(ra) # eae <dup>
     ...
     9b0:	48a080e7          	jalr	1162(ra) # e36 <exit>
        close(aa[0]);
     9b4:	f9842503          	lw	a0,-104(s0)
     9b8:	00000097          	auipc	ra,0x0
     9bc:	4a6080e7          	jalr	1190(ra) # e5e <close>
        close(1);
     9c0:	4505                	li	a0,1
     9c2:	00000097          	auipc	ra,0x0
     9c6:	49c080e7          	jalr	1180(ra) # e5e <close>
        if(dup(bb[1]) != 1){
     9ca:	fa442503          	lw	a0,-92(s0)
     9ce:	00000097          	auipc	ra,0x0
     9d2:	4e0080e7          	jalr	1248(ra) # eae <dup>
     9d6:	4785                	li	a5,1
     ...
     9f4:	446080e7          	jalr	1094(ra) # e36 <exit>
        close(bb[1]);
     9f8:	fa442503          	lw	a0,-92(s0)
     9fc:	00000097          	auipc	ra,0x0
     a00:	462080e7          	jalr	1122(ra) # e5e <close>
        char *args[2] = { "cat", 0 };
     ...
     a24:	44e080e7          	jalr	1102(ra) # e6e <exec>
        fprintf(2, "grind: cat: not found\n");
     ...
     a40:	3fa080e7          	jalr	1018(ra) # e36 <exit>
        fprintf(2, "grind: fork failed\n");
     ...
     a5c:	3de080e7          	jalr	990(ra) # e36 <exit>
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	412080e7          	jalr	1042(ra) # e86 <unlink>
  unlink("b");
     a7c:	00001517          	auipc	a0,0x1
     a80:	95450513          	addi	a0,a0,-1708 # 13d0 <malloc+0x17a>
     a84:	00000097          	auipc	ra,0x0
     a88:	402080e7          	jalr	1026(ra) # e86 <unlink>
  
  int pid1 = fork();
     a8c:	00000097          	auipc	ra,0x0
     a90:	3a2080e7          	jalr	930(ra) # e2e <fork>
  if(pid1 < 0){
  ...
  if(pid1 == 0){
    ...
    exit(1);
     ...
     acc:	36e080e7          	jalr	878(ra) # e36 <exit>
    exit(0);
  }

  int pid2 = fork();
     ad0:	00000097          	auipc	ra,0x0
     ad4:	35e080e7          	jalr	862(ra) # e2e <fork>
     ad8:	892a                	mv	s2,a0
  if(pid2 < 0){
  ...
  if(pid2 == 0){
    ...
    exit(1);
     ...
     b14:	326080e7          	jalr	806(ra) # e36 <exit>
    exit(0);
  }
  ...
  wait(&st1);
     ...
     b26:	31c080e7          	jalr	796(ra) # e3e <wait>
  if(st1 != 0){
  ...
  wait(&st2);
     ...
     b3e:	304080e7          	jalr	772(ra) # e3e <wait>

  exit(0);
     b42:	4501                	li	a0,0
     b44:	00000097          	auipc	ra,0x0
     b48:	2f2080e7          	jalr	754(ra) # e36 <exit>
    kill(pid1);
     b4c:	8526                	mv	a0,s1
     b4e:	00000097          	auipc	ra,0x0
     b52:	318080e7          	jalr	792(ra) # e66 <kill>
    kill(pid2);
     b56:	854a                	mv	a0,s2
     b58:	00000097          	auipc	ra,0x0
     b5c:	30e080e7          	jalr	782(ra) # e66 <kill>
...
main()
{
    ...
    sleep(20);
     ...
     b84:	346080e7          	jalr	838(ra) # ec6 <sleep>
    rand_next += 1;
     b88:	609c                	ld	a5,0(s1)
    ...
    int pid = fork();
     ...
     b92:	2a0080e7          	jalr	672(ra) # e2e <fork>
    if(pid == 0){
    ...
    if(pid > 0){
     ...
     ba2:	2a0080e7          	jalr	672(ra) # e3e <wait>
...
_main()
{
  ...
  exit(0);
     ...
     bbe:	27c080e7          	jalr	636(ra) # e36 <exit>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     cb0:	1a2080e7          	jalr	418(ra) # e4e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     d02:	178080e7          	jalr	376(ra) # e76 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     d12:	180080e7          	jalr	384(ra) # e8e <fstat>
     d16:	892a                	mv	s2,a0
  close(fd);
     d18:	8526                	mv	a0,s1
     d1a:	00000097          	auipc	ra,0x0
     d1e:	144080e7          	jalr	324(ra) # e5e <close>
  return r;
}
     d22:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     eec:	f6e080e7          	jalr	-146(ra) # e56 <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1330:	b92080e7          	jalr	-1134(ra) # ebe <sbrk>
  if(p == (char*)-1)
