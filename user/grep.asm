...
000000000000011a <grep>:
{
 ...
 182:	3da080e7          	jalr	986(ra) # 558 <write>
 ...
 19a:	3ba080e7          	jalr	954(ra) # 550 <read>
...
00000000000001ec <main>:
{
 ...
 22a:	352080e7          	jalr	850(ra) # 578 <open>
 22e:	84aa                	mv	s1,a0
 ...
 246:	31e080e7          	jalr	798(ra) # 560 <close>
  for(i = 2; i < argc; i++){
 ...
 256:	2e6080e7          	jalr	742(ra) # 538 <exit>
 ...
 272:	2ca080e7          	jalr	714(ra) # 538 <exit>
    grep(pattern, 0);
 276:	4581                	li	a1,0
 278:	8552                	mv	a0,s4
 ...
 288:	2b4080e7          	jalr	692(ra) # 538 <exit>
 ...
 2a6:	296080e7          	jalr	662(ra) # 538 <exit>
...
_main()
{
 ...
 2c0:	27c080e7          	jalr	636(ra) # 538 <exit>
...
gets(char *buf, int max)
{
 ...
 3b2:	1a2080e7          	jalr	418(ra) # 550 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 404:	178080e7          	jalr	376(ra) # 578 <open>
  if(fd < 0)
 ...
 414:	180080e7          	jalr	384(ra) # 590 <fstat>
 418:	892a                	mv	s2,a0
  close(fd);
 41a:	8526                	mv	a0,s1
 41c:	00000097          	auipc	ra,0x0
 420:	144080e7          	jalr	324(ra) # 560 <close>
  return r;
}
 424:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 a32:	b92080e7          	jalr	-1134(ra) # 5c0 <sbrk>
  if(p == (char*)-1)
