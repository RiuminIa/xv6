...
ls(char *path)
{
 ...
 21a:	362080e7          	jalr	866(ra) # 578 <read>
 21e:	47c1                	li	a5,16
...
main(int argc, char *argv[])
{
 ...
 2b4:	2b0080e7          	jalr	688(ra) # 560 <exit>
    ls(".");
 ...
 2ce:	296080e7          	jalr	662(ra) # 560 <exit>
...
_main()
{
 ...
 2e8:	27c080e7          	jalr	636(ra) # 560 <exit>
...
gets(char *buf, int max)
{
 ...
 3da:	1a2080e7          	jalr	418(ra) # 578 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 42c:	178080e7          	jalr	376(ra) # 5a0 <open>
  if(fd < 0)
 ...
 43c:	180080e7          	jalr	384(ra) # 5b8 <fstat>
 440:	892a                	mv	s2,a0
  close(fd);
 442:	8526                	mv	a0,s1
 444:	00000097          	auipc	ra,0x0
 448:	144080e7          	jalr	324(ra) # 588 <close>
  return r;
}
 44c:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 a5a:	b92080e7          	jalr	-1134(ra) # 5e8 <sbrk>
  if(p == (char*)-1)
