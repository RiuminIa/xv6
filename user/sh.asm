...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      20:	e02080e7          	jalr	-510(ra) # e1e <write>
  memset(buf, 0, nbuf);
      24:	864a                	mv	a2,s2
      26:	4581                	li	a1,0
      28:	8526                	mv	a0,s1
...
panic(char *s)
{
  ...
  exit(1);
      ...
      78:	d8a080e7          	jalr	-630(ra) # dfe <exit>
...
fork1(void)
{
  ...
  pid = fork();
      ...
      88:	d72080e7          	jalr	-654(ra) # df6 <fork>
  if(pid == -1)
      8c:	57fd                	li	a5,-1
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
    ...
    exit(1);
      ...
      dc:	d26080e7          	jalr	-730(ra) # dfe <exit>
    panic("runcmd");
    ...
    exec(ecmd->argv[0], ecmd->argv);
      ...
      fc:	d3e080e7          	jalr	-706(ra) # e36 <exec>
  ...
  exit(0);
     ...
     11a:	ce8080e7          	jalr	-792(ra) # dfe <exit>
      exit(1);
     11e:	4505                	li	a0,1
     120:	00001097          	auipc	ra,0x1
     124:	cde080e7          	jalr	-802(ra) # dfe <exit>
    close(rcmd->fd);
     128:	5148                	lw	a0,36(a0)
     12a:	00001097          	auipc	ra,0x1
     12e:	cfc080e7          	jalr	-772(ra) # e26 <close>
    if(open(rcmd->file, rcmd->mode) < 0){
     132:	508c                	lw	a1,32(s1)
     134:	6888                	ld	a0,16(s1)
     136:	00001097          	auipc	ra,0x1
     13a:	d08080e7          	jalr	-760(ra) # e3e <open>
    ...
    runcmd(rcmd->cmd);
     ...
     166:	c9c080e7          	jalr	-868(ra) # dfe <exit>
    if(fork1() == 0)
    ...
    wait(0);
     ...
     184:	c86080e7          	jalr	-890(ra) # e06 <wait>
    runcmd(lcmd->right);
    ...
    if(pipe(p) < 0)
     ...
     19a:	c78080e7          	jalr	-904(ra) # e0e <pipe>
    ...
    if(fork1() == 0){
     ...
     1b2:	c78080e7          	jalr	-904(ra) # e26 <close>
      dup(p[1]);
     1b6:	fdc42503          	lw	a0,-36(s0)
     1ba:	00001097          	auipc	ra,0x1
     1be:	cbc080e7          	jalr	-836(ra) # e76 <dup>
      close(p[0]);
     1c2:	fd842503          	lw	a0,-40(s0)
     1c6:	00001097          	auipc	ra,0x1
     1ca:	c60080e7          	jalr	-928(ra) # e26 <close>
      close(p[1]);
     1ce:	fdc42503          	lw	a0,-36(s0)
     1d2:	00001097          	auipc	ra,0x1
     1d6:	c54080e7          	jalr	-940(ra) # e26 <close>
      runcmd(pcmd->left);
     1da:	6488                	ld	a0,8(s1)
    ...
    if(fork1() == 0){
     ...
     202:	c28080e7          	jalr	-984(ra) # e26 <close>
      dup(p[0]);
     206:	fd842503          	lw	a0,-40(s0)
     20a:	00001097          	auipc	ra,0x1
     20e:	c6c080e7          	jalr	-916(ra) # e76 <dup>
      close(p[0]);
     212:	fd842503          	lw	a0,-40(s0)
     216:	00001097          	auipc	ra,0x1
     21a:	c10080e7          	jalr	-1008(ra) # e26 <close>
      close(p[1]);
     21e:	fdc42503          	lw	a0,-36(s0)
     222:	00001097          	auipc	ra,0x1
     226:	c04080e7          	jalr	-1020(ra) # e26 <close>
      runcmd(pcmd->right);
    ...
    close(p[0]);
     ...
     23c:	bee080e7          	jalr	-1042(ra) # e26 <close>
    close(p[1]);
     240:	fdc42503          	lw	a0,-36(s0)
     244:	00001097          	auipc	ra,0x1
     248:	be2080e7          	jalr	-1054(ra) # e26 <close>
    wait(0);
     24c:	4501                	li	a0,0
     24e:	00001097          	auipc	ra,0x1
     252:	bb8080e7          	jalr	-1096(ra) # e06 <wait>
    wait(0);
     256:	4501                	li	a0,0
     258:	00001097          	auipc	ra,0x1
     25c:	bae080e7          	jalr	-1106(ra) # e06 <wait>
    break;
...
0000000000000a74 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a94:	3ae080e7          	jalr	942(ra) # e3e <open>
    ...
    if(fd >= 3){
     ...
     aa6:	384080e7          	jalr	900(ra) # e26 <close>
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    wait(0);
     ...
     acc:	33e080e7          	jalr	830(ra) # e06 <wait>
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b2a:	348080e7          	jalr	840(ra) # e6e <chdir>
  ...
  exit(0);
     ...
     b6c:	296080e7          	jalr	662(ra) # dfe <exit>
...
_main()
{
  ...
  exit(0);
     ...
     b86:	27c080e7          	jalr	636(ra) # dfe <exit>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    cc = read(0, &c, 1);
     ...
     c78:	1a2080e7          	jalr	418(ra) # e16 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
     ...
     cca:	178080e7          	jalr	376(ra) # e3e <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
     ...
     cda:	180080e7          	jalr	384(ra) # e56 <fstat>
     cde:	892a                	mv	s2,a0
  close(fd);
     ce0:	8526                	mv	a0,s1
     ce2:	00000097          	auipc	ra,0x0
     ce6:	144080e7          	jalr	324(ra) # e26 <close>
  return r;
}
     cea:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     eb4:	f6e080e7          	jalr	-146(ra) # e1e <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    12f8:	b92080e7          	jalr	-1134(ra) # e86 <sbrk>
  if(p == (char*)-1)
