...
_main()
{
  ...
  7a:	27c080e7          	jalr	636(ra) # 2f2 <exit>
...
gets(char *buf, int max)
{
 ...
 16c:	1a2080e7          	jalr	418(ra) # 30a <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1be:	178080e7          	jalr	376(ra) # 332 <open>
  if(fd < 0)
 ...
 1ce:	180080e7          	jalr	384(ra) # 34a <fstat>
 1d2:	892a                	mv	s2,a0
  close(fd);
 1d4:	8526                	mv	a0,s1
 1d6:	00000097          	auipc	ra,0x0
 1da:	144080e7          	jalr	324(ra) # 31a <close>
  return r;
}
 1de:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 7ec:	b92080e7          	jalr	-1134(ra) # 37a <sbrk>
  if(p == (char*)-1)
