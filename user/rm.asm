...
main(int argc, char *argv[])
{
  ...
  2c:	32c080e7          	jalr	812(ra) # 354 <unlink>
  ...
  54:	2b4080e7          	jalr	692(ra) # 304 <exit>
  ...
  72:	296080e7          	jalr	662(ra) # 304 <exit>
...
_main()
{
  ...
  8c:	27c080e7          	jalr	636(ra) # 304 <exit>
...
gets(char *buf, int max)
{
 ...
 17e:	1a2080e7          	jalr	418(ra) # 31c <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1d0:	178080e7          	jalr	376(ra) # 344 <open>
  if(fd < 0)
 ...
 1e0:	180080e7          	jalr	384(ra) # 35c <fstat>
 1e4:	892a                	mv	s2,a0
  close(fd);
 1e6:	8526                	mv	a0,s1
 1e8:	00000097          	auipc	ra,0x0
 1ec:	144080e7          	jalr	324(ra) # 32c <close>
  return r;
}
 1f0:	854a                	mv	a0,s2
