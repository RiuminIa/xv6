...
_main()
{
 ...
 122:	27c080e7          	jalr	636(ra) # 39a <exit>
...
gets(char *buf, int max)
{
 ...
 214:	1a2080e7          	jalr	418(ra) # 3b2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 266:	178080e7          	jalr	376(ra) # 3da <open>
  if(fd < 0)
 ...
 276:	180080e7          	jalr	384(ra) # 3f2 <fstat>
 27a:	892a                	mv	s2,a0
  close(fd);
 27c:	8526                	mv	a0,s1
 27e:	00000097          	auipc	ra,0x0
 282:	144080e7          	jalr	324(ra) # 3c2 <close>
  return r;
}
 286:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 894:	b92080e7          	jalr	-1134(ra) # 422 <sbrk>
  if(p == (char*)-1)
