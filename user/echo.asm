...
main(int argc, char *argv[])
{
  ...
  44:	2fc080e7          	jalr	764(ra) # 33c <write>
  for(i = 1; i < argc; i++){
  ...
  68:	2d8080e7          	jalr	728(ra) # 33c <write>
    if(i + 1 < argc){
  ...
  80:	2c0080e7          	jalr	704(ra) # 33c <write>
    }
  }
  exit(0);
  84:	4501                	li	a0,0
  86:	00000097          	auipc	ra,0x0
  8a:	296080e7          	jalr	662(ra) # 31c <exit>
...
_main()
{
  ...
  a4:	27c080e7          	jalr	636(ra) # 31c <exit>
...
gets(char *buf, int max)
{
 ...
 196:	1a2080e7          	jalr	418(ra) # 334 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1e8:	178080e7          	jalr	376(ra) # 35c <open>
  if(fd < 0)
 ...
 204:	144080e7          	jalr	324(ra) # 344 <close>
  return r;
}
 208:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 816:	b92080e7          	jalr	-1134(ra) # 3a4 <sbrk>
  if(p == (char*)-1)
