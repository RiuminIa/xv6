...
main(int argc, char *argv[])
{
  ...
  2e:	7b658593          	addi	a1,a1,1974 # 7e0 <malloc+0xec>
  32:	4509                	li	a0,2
  34:	00000097          	auipc	ra,0x0
  38:	5da080e7          	jalr	1498(ra) # 60e <fprintf>
      exit(1);
  3c:	4505                	li	a0,1
...
_main()
{
  ...
  5c:	27c080e7          	jalr	636(ra) # 2d4 <exit>
...
gets(char *buf, int max)
{
 ...
 14e:	1a2080e7          	jalr	418(ra) # 2ec <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1a0:	178080e7          	jalr	376(ra) # 314 <open>
  if(fd < 0)
 ...
 1b0:	180080e7          	jalr	384(ra) # 32c <fstat>
 1b4:	892a                	mv	s2,a0
  close(fd);
 1b6:	8526                	mv	a0,s1
 1b8:	00000097          	auipc	ra,0x0
 1bc:	144080e7          	jalr	324(ra) # 2fc <close>
  return r;
}
 1c0:	854a                	mv	a0,s2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bc:	49050513          	addi	a0,a0,1168 # 848 <digits>
 3c0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c0:	33470713          	addi	a4,a4,820 # 7f0 <malloc+0xfc>
 ...
 54a:	302b8b93          	addi	s7,s7,770 # 848 <digits>
 ...
 59e:	24e90913          	addi	s2,s2,590 # 7e8 <malloc+0xf4>
        while(*s != 0){
