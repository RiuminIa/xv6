...
wc(int fd, char *name)
{
  ...
  80:	3b4080e7          	jalr	948(ra) # 430 <read>
  84:	8b2a                	mv	s6,a0
  ...
  ea:	332080e7          	jalr	818(ra) # 418 <exit>
...
main(int argc, char *argv[])
{
 ...
 120:	33c080e7          	jalr	828(ra) # 458 <open>
 124:	84aa                	mv	s1,a0
 ...
 186:	296080e7          	jalr	662(ra) # 418 <exit>
...
_main()
{
 ...
 1a0:	27c080e7          	jalr	636(ra) # 418 <exit>
...
gets(char *buf, int max)
{
 ...
 292:	1a2080e7          	jalr	418(ra) # 430 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 2e4:	178080e7          	jalr	376(ra) # 458 <open>
  if(fd < 0)
 ...
 2f4:	180080e7          	jalr	384(ra) # 470 <fstat>
 2f8:	892a                	mv	s2,a0
  close(fd);
 2fa:	8526                	mv	a0,s1
 2fc:	00000097          	auipc	ra,0x0
 300:	144080e7          	jalr	324(ra) # 440 <close>
  return r;
}
 304:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 912:	b92080e7          	jalr	-1134(ra) # 4a0 <sbrk>
  if(p == (char*)-1)
