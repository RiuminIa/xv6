...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      14:	bc6080e7          	jalr	-1082(ra) # 5bd6 <open>
    if(fd >= 0){
    ...
    int fd = open((char *)addr, O_CREATE|O_WRONLY);
      ...
      26:	bb4080e7          	jalr	-1100(ra) # 5bd6 <open>
    uint64 addr = addrs[ai];
      2a:	55fd                	li	a1,-1
    if(fd >= 0){
    ...
    uint64 addr = addrs[ai];
      ...
      54:	b46080e7          	jalr	-1210(ra) # 5b96 <exit>
      ...
      74:	8082                	ret
{
      ...
      96:	b04080e7          	jalr	-1276(ra) # 5b96 <exit>
...
000000000000009a <opentest>:
{
  ...
  if(fd >= 0){
    ...
    exit(1);
      ...
      fc:	a9e080e7          	jalr	-1378(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     118:	a82080e7          	jalr	-1406(ra) # 5b96 <exit>
...
000000000000011c <truncate2>:
{
  ...
  int n = write(fd1, "x", 1);
     ...
     18a:	a30080e7          	jalr	-1488(ra) # 5bb6 <write>
  if(n != -1){
     18e:	57fd                	li	a5,-1
  ...
  unlink("truncfile");
     ...
     1a0:	a4a080e7          	jalr	-1462(ra) # 5be6 <unlink>
  close(fd1);
     1a4:	8526                	mv	a0,s1
     1a6:	00006097          	auipc	ra,0x6
     1aa:	a18080e7          	jalr	-1512(ra) # 5bbe <close>
  close(fd2);
     1ae:	854a                	mv	a0,s2
     1b0:	00006097          	auipc	ra,0x6
     1b4:	a0e080e7          	jalr	-1522(ra) # 5bbe <close>
}
    ...
    exit(1);
     ...
     1e0:	9ba080e7          	jalr	-1606(ra) # 5b96 <exit>
...
00000000000001e4 <createtest>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    fd = open(name, O_CREATE|O_RDWR);
     ...
     214:	9c6080e7          	jalr	-1594(ra) # 5bd6 <open>
    close(fd);
     218:	00006097          	auipc	ra,0x6
     21c:	9a6080e7          	jalr	-1626(ra) # 5bbe <close>
  for(i = 0; i < N; i++){
  ...
  for(i = 0; i < N; i++){
    ...
    unlink(name);
     ...
     24a:	9a0080e7          	jalr	-1632(ra) # 5be6 <unlink>
  for(i = 0; i < N; i++){
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     288:	962080e7          	jalr	-1694(ra) # 5be6 <unlink>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2b0:	92a080e7          	jalr	-1750(ra) # 5bd6 <open>
     2b4:	892a                	mv	s2,a0
    if(fd < 0){
     ...
     2c2:	8f8080e7          	jalr	-1800(ra) # 5bb6 <write>
     2c6:	89aa                	mv	s3,a0
      if(cc != sz){
     ...
     2d6:	8e4080e7          	jalr	-1820(ra) # 5bb6 <write>
      if(cc != sz){
     2da:	04951a63          	bne	a0,s1,32e <bigwrite+0xca>
    close(fd);
     2de:	854a                	mv	a0,s2
     2e0:	00006097          	auipc	ra,0x6
     2e4:	8de080e7          	jalr	-1826(ra) # 5bbe <close>
    unlink("bigwrite");
     2e8:	8556                	mv	a0,s5
     2ea:	00006097          	auipc	ra,0x6
     2ee:	8fc080e7          	jalr	-1796(ra) # 5be6 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     328:	872080e7          	jalr	-1934(ra) # 5b96 <exit>
      if(cc != sz){
     32c:	89a6                	mv	s3,s1
     ...
     34a:	850080e7          	jalr	-1968(ra) # 5b96 <exit>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     36a:	880080e7          	jalr	-1920(ra) # 5be6 <unlink>
  ...
  for(int i = 0; i < assumed_free; i++){
    ...
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     38a:	850080e7          	jalr	-1968(ra) # 5bd6 <open>
     38e:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    write(fd, (char*)0xffffffffffL, 1);
     ...
     39c:	81e080e7          	jalr	-2018(ra) # 5bb6 <write>
    close(fd);
     3a0:	8526                	mv	a0,s1
     3a2:	00006097          	auipc	ra,0x6
     3a6:	81c080e7          	jalr	-2020(ra) # 5bbe <close>
    unlink("junk");
     3aa:	854e                	mv	a0,s3
     3ac:	00006097          	auipc	ra,0x6
     3b0:	83a080e7          	jalr	-1990(ra) # 5be6 <unlink>
  for(int i = 0; i < assumed_free; i++){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3ca:	810080e7          	jalr	-2032(ra) # 5bd6 <open>
     3ce:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3e2:	7d8080e7          	jalr	2008(ra) # 5bb6 <write>
     3e6:	4785                	li	a5,1
    ...
    exit(1);
     ...
     402:	798080e7          	jalr	1944(ra) # 5b96 <exit>
      printf("open junk failed\n");
     ...
     41c:	77e080e7          	jalr	1918(ra) # 5b96 <exit>
    printf("open junk failed\n");
...
outofinodes(char *s)
{
  ...
  for(int i = 0; i < nzz; i++){
    ...
    close(fd);
     ...
     4ca:	6f8080e7          	jalr	1784(ra) # 5bbe <close>
  for(int i = 0; i < nzz; i++){
  ...
  for(int i = 0; i < nzz; i++){
    ...
    unlink(name);
     ...
     516:	6d4080e7          	jalr	1748(ra) # 5be6 <unlink>
  for(int i = 0; i < nzz; i++){
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     566:	674080e7          	jalr	1652(ra) # 5bd6 <open>
     56a:	84aa                	mv	s1,a0
    if(fd < 0){
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     612:	588080e7          	jalr	1416(ra) # 5b96 <exit>
     ...
     630:	56a080e7          	jalr	1386(ra) # 5b96 <exit>
     ...
     64e:	54c080e7          	jalr	1356(ra) # 5b96 <exit>
      printf("pipe() failed\n");
     ...
     668:	532080e7          	jalr	1330(ra) # 5b96 <exit>
     ...
     686:	514080e7          	jalr	1300(ra) # 5b96 <exit>
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6ca:	510080e7          	jalr	1296(ra) # 5bd6 <open>
     6ce:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    n = write(fds[1], "x", 1);
     ...
     70a:	4b0080e7          	jalr	1200(ra) # 5bb6 <write>
    if(n != 1){
     70e:	4785                	li	a5,1
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     772:	428080e7          	jalr	1064(ra) # 5b96 <exit>
     ...
     790:	40a080e7          	jalr	1034(ra) # 5b96 <exit>
      printf("pipe() failed\n");
     ...
     7aa:	3f0080e7          	jalr	1008(ra) # 5b96 <exit>
     ...
     7c4:	3d6080e7          	jalr	982(ra) # 5b96 <exit>
     ...
     7e2:	3b8080e7          	jalr	952(ra) # 5b96 <exit>
...
00000000000007e6 <truncate1>:
{
  ...
  unlink("truncfile");
     ...
     806:	3e4080e7          	jalr	996(ra) # 5be6 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
     ...
     81a:	3c0080e7          	jalr	960(ra) # 5bd6 <open>
     81e:	84aa                	mv	s1,a0
  write(fd1, "abcd", 4);
     820:	4611                	li	a2,4
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     876:	364080e7          	jalr	868(ra) # 5bd6 <open>
     87a:	89aa                	mv	s3,a0
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     8b2:	300080e7          	jalr	768(ra) # 5bae <read>
     8b6:	8a2a                	mv	s4,a0
  if(n != 0){
  ...
  n = read(fd2, buf, sizeof(buf));
     ...
     8f4:	2be080e7          	jalr	702(ra) # 5bae <read>
  if(n != 2){
     8f8:	4789                	li	a5,2
  ...
  unlink("truncfile");
     ...
     90a:	2e0080e7          	jalr	736(ra) # 5be6 <unlink>
  close(fd1);
     90e:	854e                	mv	a0,s3
     910:	00005097          	auipc	ra,0x5
     914:	2ae080e7          	jalr	686(ra) # 5bbe <close>
  close(fd2);
     918:	8526                	mv	a0,s1
     91a:	00005097          	auipc	ra,0x5
     91e:	2a4080e7          	jalr	676(ra) # 5bbe <close>
  close(fd3);
     922:	854a                	mv	a0,s2
     924:	00005097          	auipc	ra,0x5
     928:	29a080e7          	jalr	666(ra) # 5bbe <close>
}
    ...
    exit(1);
     ...
     958:	242080e7          	jalr	578(ra) # 5b96 <exit>
    printf("aaa fd3=%d\n", fd3);
     95c:	85ca                	mv	a1,s2
    ...
    exit(1);
     ...
     988:	212080e7          	jalr	530(ra) # 5b96 <exit>
    printf("bbb fd2=%d\n", fd2);
     98c:	85a6                	mv	a1,s1
    ...
    exit(1);
     ...
     9b8:	1e2080e7          	jalr	482(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     9d6:	1c4080e7          	jalr	452(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     9f4:	1a6080e7          	jalr	422(ra) # 5b96 <exit>
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a1e:	1bc080e7          	jalr	444(ra) # 5bd6 <open>
  if(fd < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a48:	172080e7          	jalr	370(ra) # 5bb6 <write>
     a4c:	47a9                	li	a5,10
    ...
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     ...
     a5c:	15e080e7          	jalr	350(ra) # 5bb6 <write>
     a60:	47a9                	li	a5,10
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     a9e:	114080e7          	jalr	276(ra) # 5bae <read>
  if(i != N*SZ*2){
  ...
  if(unlink("small") < 0){
    ...
    exit(1);
     ...
     af4:	0a6080e7          	jalr	166(ra) # 5b96 <exit>
     ...
     b12:	088080e7          	jalr	136(ra) # 5b96 <exit>
     ...
     b30:	06a080e7          	jalr	106(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     b4c:	04e080e7          	jalr	78(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     b68:	032080e7          	jalr	50(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     b84:	016080e7          	jalr	22(ra) # 5b96 <exit>
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     bac:	02e080e7          	jalr	46(ra) # 5bd6 <open>
     bb0:	89aa                	mv	s3,a0
  for(i = 0; i < MAXFILE; i++){
     bb2:	4481                	li	s1,0
    ((int*)buf)[0] = i;
  ...
  if(fd < 0){
    ...
    if(write(fd, buf, BSIZE) != BSIZE){
     ...
     bd4:	fe6080e7          	jalr	-26(ra) # 5bb6 <write>
  ...
  if(fd < 0){
    ...
    i = read(fd, buf, BSIZE);
     ...
     c1e:	f94080e7          	jalr	-108(ra) # 5bae <read>
    if(i == 0){
    ...
    exit(1);
     ...
     c50:	f4a080e7          	jalr	-182(ra) # 5b96 <exit>
     ...
     c6e:	f2c080e7          	jalr	-212(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     c8a:	f10080e7          	jalr	-240(ra) # 5b96 <exit>
      if(n == MAXFILE - 1){
  ...
  if(unlink("big") < 0){
     ...
     ce2:	eb8080e7          	jalr	-328(ra) # 5b96 <exit>
     ...
     d00:	e9a080e7          	jalr	-358(ra) # 5b96 <exit>
     ...
     d1e:	e7c080e7          	jalr	-388(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     d3a:	e60080e7          	jalr	-416(ra) # 5b96 <exit>
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d5e:	e7c080e7          	jalr	-388(ra) # 5bd6 <open>
  if(fd < 0){
  ...
  if(unlink("unlinkread") != 0){
     ...
     da8:	e42080e7          	jalr	-446(ra) # 5be6 <unlink>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     dbe:	e1c080e7          	jalr	-484(ra) # 5bd6 <open>
     dc2:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     dc4:	460d                	li	a2,3
     ...
     dd2:	de8080e7          	jalr	-536(ra) # 5bb6 <write>
  close(fd1);
     dd6:	854a                	mv	a0,s2
     dd8:	00005097          	auipc	ra,0x5
     ddc:	de6080e7          	jalr	-538(ra) # 5bbe <close>
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     df0:	dc2080e7          	jalr	-574(ra) # 5bae <read>
     df4:	4795                	li	a5,5
  ...
  unlink("unlinkread");
    ...
    exit(1);
     ...
     e64:	d36080e7          	jalr	-714(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     e80:	d1a080e7          	jalr	-742(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     e9c:	cfe080e7          	jalr	-770(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     eb8:	ce2080e7          	jalr	-798(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     ed4:	cc6080e7          	jalr	-826(ra) # 5b96 <exit>
    ...
    exit(1);
     ...
     ef0:	caa080e7          	jalr	-854(ra) # 5b96 <exit>
...
0000000000000ef4 <linktest>:
{
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
     ...
     f32:	ca8080e7          	jalr	-856(ra) # 5bd6 <open>
  if(fd < 0){
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f4a:	c70080e7          	jalr	-912(ra) # 5bb6 <write>
     f4e:	4795                	li	a5,5
     f50:	10f51863          	bne	a0,a5,1060 <linktest+0x16c>
  close(fd);
     f54:	8526                	mv	a0,s1
     f56:	00005097          	auipc	ra,0x5
     f5a:	c68080e7          	jalr	-920(ra) # 5bbe <close>
  if(link("lf1", "lf2") < 0){
     ...
     f72:	c88080e7          	jalr	-888(ra) # 5bf6 <link>
  ...
  fd = open("lf2", 0);
     ...
     fae:	c2c080e7          	jalr	-980(ra) # 5bd6 <open>
     fb2:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  unlink("lf2");
     ...
     ffc:	bee080e7          	jalr	-1042(ra) # 5be6 <unlink>
  if(link("lf2", "lf1") >= 0){
    ...
    1014:	be6080e7          	jalr	-1050(ra) # 5bf6 <link>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1030:	bca080e7          	jalr	-1078(ra) # 5bf6 <link>
    ...
    105c:	b3e080e7          	jalr	-1218(ra) # 5b96 <exit>
    ...
    1078:	b22080e7          	jalr	-1246(ra) # 5b96 <exit>
    ...
    1094:	b06080e7          	jalr	-1274(ra) # 5b96 <exit>
    ...
    10b0:	aea080e7          	jalr	-1302(ra) # 5b96 <exit>
    ...
    10cc:	ace080e7          	jalr	-1330(ra) # 5b96 <exit>
    ...
    10e8:	ab2080e7          	jalr	-1358(ra) # 5b96 <exit>
    ...
    1104:	a96080e7          	jalr	-1386(ra) # 5b96 <exit>
    ...
    1120:	a7a080e7          	jalr	-1414(ra) # 5b96 <exit>
    ...
    113c:	a5e080e7          	jalr	-1442(ra) # 5b96 <exit>
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1170:	a8a080e7          	jalr	-1398(ra) # 5bf6 <link>
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    11aa:	9f0080e7          	jalr	-1552(ra) # 5b96 <exit>
...
00000000000011ae <bigdir>:
{
  ...
  unlink("bd");
    ...
    11d0:	a1a080e7          	jalr	-1510(ra) # 5be6 <unlink>
  fd = open("bd", O_CREATE);
    ...
    11e4:	9f6080e7          	jalr	-1546(ra) # 5bd6 <open>
  if(fd < 0){
    11e8:	0c054963          	bltz	a0,12ba <bigdir+0x10c>
  close(fd);
    11ec:	00005097          	auipc	ra,0x5
    11f0:	9d2080e7          	jalr	-1582(ra) # 5bbe <close>
  for(i = 0; i < N; i++){
    11f4:	4901                	li	s2,0
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    123e:	9bc080e7          	jalr	-1604(ra) # 5bf6 <link>
    1242:	84aa                	mv	s1,a0
  ...
  unlink("bd");
    ...
    1258:	992080e7          	jalr	-1646(ra) # 5be6 <unlink>
    name[0] = 'x';
  ...
  for(i = 0; i < N; i++){
    ...
    129a:	950080e7          	jalr	-1712(ra) # 5be6 <unlink>
  ...
  for(i = 0; i < N; i++){
    ...
    12d2:	8c8080e7          	jalr	-1848(ra) # 5b96 <exit>
    ...
    12f2:	8a8080e7          	jalr	-1880(ra) # 5b96 <exit>
    ...
    130e:	88c080e7          	jalr	-1908(ra) # 5b96 <exit>
...
0000000000001312 <pgbug>:
{
  ...
  exec(big, argv);
    ...
    1332:	8a0080e7          	jalr	-1888(ra) # 5bce <exec>
  pipe(big);
    1336:	6088                	ld	a0,0(s1)
    1338:	00005097          	auipc	ra,0x5
    133c:	86e080e7          	jalr	-1938(ra) # 5ba6 <pipe>
  exit(0);
    1340:	4501                	li	a0,0
    1342:	00005097          	auipc	ra,0x5
    1346:	854080e7          	jalr	-1964(ra) # 5b96 <exit>
...
000000000000134a <badarg>:
{
    ...
    137e:	854080e7          	jalr	-1964(ra) # 5bce <exec>
  ...
  exit(0);
    ...
    138c:	80e080e7          	jalr	-2034(ra) # 5b96 <exit>
...
0000000000001390 <copyinstr2>:
{
  ...
  int ret = unlink(b);
    ...
    13ba:	830080e7          	jalr	-2000(ra) # 5be6 <unlink>
  if(ret != -1){
    13be:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    13d0:	80a080e7          	jalr	-2038(ra) # 5bd6 <open>
  if(fd != -1){
    13d4:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    13e4:	816080e7          	jalr	-2026(ra) # 5bf6 <link>
  if(ret != -1){
    13e8:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    140a:	7c8080e7          	jalr	1992(ra) # 5bce <exec>
  if(ret != -1){
    140e:	57fd                	li	a5,-1
    1410:	0ef51963          	bne	a0,a5,1502 <copyinstr2+0x172>
  int pid = fork();
    1414:	00004097          	auipc	ra,0x4
    1418:	77a080e7          	jalr	1914(ra) # 5b8e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    147a:	758080e7          	jalr	1880(ra) # 5bce <exec>
    if(ret != -1){
    147e:	57fd                	li	a5,-1
    ...
    149c:	6fe080e7          	jalr	1790(ra) # 5b96 <exit>
    ...
    14bc:	6de080e7          	jalr	1758(ra) # 5b96 <exit>
    ...
    14dc:	6be080e7          	jalr	1726(ra) # 5b96 <exit>
    ...
    14fe:	69c080e7          	jalr	1692(ra) # 5b96 <exit>
    ...
    151e:	67c080e7          	jalr	1660(ra) # 5b96 <exit>
    printf("fork failed\n");
  ...
  if(st != 747){
    ...
    1582:	618080e7          	jalr	1560(ra) # 5b96 <exit>
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15aa:	630080e7          	jalr	1584(ra) # 5bd6 <open>
    15ae:	00004097          	auipc	ra,0x4
    15b2:	610080e7          	jalr	1552(ra) # 5bbe <close>
  pid = fork();
    15b6:	00004097          	auipc	ra,0x4
    15ba:	5d8080e7          	jalr	1496(ra) # 5b8e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    15e0:	5fa080e7          	jalr	1530(ra) # 5bd6 <open>
    15e4:	84aa                	mv	s1,a0
      if(fd < 0){
    ...
    15f2:	5c8080e7          	jalr	1480(ra) # 5bb6 <write>
      if(n != 10){
    15f6:	47a9                	li	a5,10
    ...
    1602:	5c0080e7          	jalr	1472(ra) # 5bbe <close>
      fd = open("truncfile", O_RDONLY);
    1606:	4581                	li	a1,0
    1608:	8552                	mv	a0,s4
    160a:	00004097          	auipc	ra,0x4
    160e:	5cc080e7          	jalr	1484(ra) # 5bd6 <open>
    1612:	84aa                	mv	s1,a0
      read(fd, buf, sizeof(buf));
    1614:	02000613          	li	a2,32
    1618:	f9840593          	addi	a1,s0,-104
    161c:	00004097          	auipc	ra,0x4
    1620:	592080e7          	jalr	1426(ra) # 5bae <read>
      close(fd);
    1624:	8526                	mv	a0,s1
    1626:	00004097          	auipc	ra,0x4
    162a:	598080e7          	jalr	1432(ra) # 5bbe <close>
    for(int i = 0; i < 100; i++){
    ...
    163a:	560080e7          	jalr	1376(ra) # 5b96 <exit>
    ...
    1656:	544080e7          	jalr	1348(ra) # 5b96 <exit>
    ...
    1672:	528080e7          	jalr	1320(ra) # 5b96 <exit>
    ...
    1690:	50a080e7          	jalr	1290(ra) # 5b96 <exit>
    ...
    16b2:	528080e7          	jalr	1320(ra) # 5bd6 <open>
    16b6:	84aa                	mv	s1,a0
    if(fd < 0){
    ...
    16c4:	4f6080e7          	jalr	1270(ra) # 5bb6 <write>
    if(n != 3){
    16c8:	478d                	li	a5,3
    ...
    16d4:	4ee080e7          	jalr	1262(ra) # 5bbe <close>
  for(int i = 0; i < 150; i++){
  ...
  exit(xstatus);
    ...
    171e:	47c080e7          	jalr	1148(ra) # 5b96 <exit>
    ...
    173c:	45e080e7          	jalr	1118(ra) # 5b96 <exit>
...
0000000000001740 <exectest>:
{
  ...
  unlink("echo-ok");
    ...
    1776:	474080e7          	jalr	1140(ra) # 5be6 <unlink>
  pid = fork();
    177a:	00004097          	auipc	ra,0x4
    177e:	414080e7          	jalr	1044(ra) # 5b8e <fork>
  if(pid < 0) {
  ...
  if(pid == 0) {
    ...
    1790:	432080e7          	jalr	1074(ra) # 5bbe <close>
    ...
    17a4:	436080e7          	jalr	1078(ra) # 5bd6 <open>
    if(fd < 0) {
    ...
    17ca:	3d0080e7          	jalr	976(ra) # 5b96 <exit>
     printf("%s: fork failed\n", s);
    17ce:	85ca                	mv	a1,s2
    ...
    17e6:	3b4080e7          	jalr	948(ra) # 5b96 <exit>
    ...
    1802:	398080e7          	jalr	920(ra) # 5b96 <exit>
  ...
  if(xstatus != 0)
    ...
    1838:	362080e7          	jalr	866(ra) # 5b96 <exit>
    ...
    1854:	346080e7          	jalr	838(ra) # 5b96 <exit>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    187a:	360080e7          	jalr	864(ra) # 5bd6 <open>
  if(fd < 0) {
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    188c:	326080e7          	jalr	806(ra) # 5bae <read>
    1890:	4789                	li	a5,2
    ...
    18ae:	2ec080e7          	jalr	748(ra) # 5b96 <exit>
    printf("%s: open failed\n", s);
    18b2:	85ca                	mv	a1,s2
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    190e:	28c080e7          	jalr	652(ra) # 5b96 <exit>
    exit(0);
    1912:	4501                	li	a0,0
    1914:	00004097          	auipc	ra,0x4
    1918:	282080e7          	jalr	642(ra) # 5b96 <exit>
...
000000000000191c <pipe1>:
{
  ...
  if(pipe(fds) != 0){
    ...
    193c:	26e080e7          	jalr	622(ra) # 5ba6 <pipe>
    1940:	e93d                	bnez	a0,19b6 <pipe1+0x9a>
    1942:	84aa                	mv	s1,a0
  pid = fork();
    1944:	00004097          	auipc	ra,0x4
    1948:	24a080e7          	jalr	586(ra) # 5b8e <fork>
    194c:	8a2a                	mv	s4,a0
  if(pid == 0){
    ...
    195c:	266080e7          	jalr	614(ra) # 5bbe <close>
    total = 0;
    1960:	8a26                	mv	s4,s1
    cc = 1;
    1962:	4985                	li	s3,1
    ...
    1978:	23a080e7          	jalr	570(ra) # 5bae <read>
    ...
    19ce:	1cc080e7          	jalr	460(ra) # 5b96 <exit>
    close(fds[0]);
    19d2:	fa842503          	lw	a0,-88(s0)
    19d6:	00004097          	auipc	ra,0x4
    19da:	1e8080e7          	jalr	488(ra) # 5bbe <close>
    for(n = 0; n < N; n++){
    ...
    19f6:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a1c:	19e080e7          	jalr	414(ra) # 5bb6 <write>
    ...
    1a38:	162080e7          	jalr	354(ra) # 5b96 <exit>
    ...
    1a54:	146080e7          	jalr	326(ra) # 5b96 <exit>
    ...
    1ae2:	0b8080e7          	jalr	184(ra) # 5b96 <exit>
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b02:	090080e7          	jalr	144(ra) # 5b8e <fork>
    1b06:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    1b16:	08c080e7          	jalr	140(ra) # 5b9e <wait>
  ...
  for(i = 0; i < 100; i++){
    ...
    1b54:	046080e7          	jalr	70(ra) # 5b96 <exit>
    ...
    1b70:	02a080e7          	jalr	42(ra) # 5b96 <exit>
    ...
    1b8c:	00e080e7          	jalr	14(ra) # 5b96 <exit>
      exit(i);
    1b90:	854a                	mv	a0,s2
    1b92:	00004097          	auipc	ra,0x4
    1b96:	004080e7          	jalr	4(ra) # 5b96 <exit>
...
0000000000001b9a <twochildren>:
{
    ...
    1bb0:	fe2080e7          	jalr	-30(ra) # 5b8e <fork>
    if(pid1 < 0){
    ...
    1bbe:	fd4080e7          	jalr	-44(ra) # 5b8e <fork>
      if(pid2 < 0){
    ...
    1bce:	fd4080e7          	jalr	-44(ra) # 5b9e <wait>
        wait(0);
    1bd2:	4501                	li	a0,0
    1bd4:	00004097          	auipc	ra,0x4
    1bd8:	fca080e7          	jalr	-54(ra) # 5b9e <wait>
  for(int i = 0; i < 1000; i++){
    ...
    1c04:	f96080e7          	jalr	-106(ra) # 5b96 <exit>
      exit(0);
    1c08:	00004097          	auipc	ra,0x4
    1c0c:	f8e080e7          	jalr	-114(ra) # 5b96 <exit>
        printf("%s: fork failed\n", s);
    1c10:	85ca                	mv	a1,s2
    ...
    1c28:	f72080e7          	jalr	-142(ra) # 5b96 <exit>
        exit(0);
    1c2c:	00004097          	auipc	ra,0x4
    1c30:	f6a080e7          	jalr	-150(ra) # 5b96 <exit>
...
0000000000001c34 <forkfork>:
{
    ...
    1c44:	f4e080e7          	jalr	-178(ra) # 5b8e <fork>
    if(pid < 0){
    ...
    1c52:	f40080e7          	jalr	-192(ra) # 5b8e <fork>
    if(pid < 0){
    ...
    1c64:	f3e080e7          	jalr	-194(ra) # 5b9e <wait>
    if(xstatus != 0) {
    ...
    1c76:	f2c080e7          	jalr	-212(ra) # 5b9e <wait>
    if(xstatus != 0) {
    ...
    1ca2:	ef8080e7          	jalr	-264(ra) # 5b96 <exit>
{
    1ca6:	0c800493          	li	s1,200
        int pid1 = fork();
    1caa:	00004097          	auipc	ra,0x4
    1cae:	ee4080e7          	jalr	-284(ra) # 5b8e <fork>
        if(pid1 < 0){
    ...
    1cbe:	ee4080e7          	jalr	-284(ra) # 5b9e <wait>
      for(int j = 0; j < 200; j++){
    ...
    1ccc:	ece080e7          	jalr	-306(ra) # 5b96 <exit>
          exit(1);
    1cd0:	4505                	li	a0,1
    1cd2:	00004097          	auipc	ra,0x4
    1cd6:	ec4080e7          	jalr	-316(ra) # 5b96 <exit>
          exit(0);
    1cda:	00004097          	auipc	ra,0x4
    1cde:	ebc080e7          	jalr	-324(ra) # 5b96 <exit>
    ...
    1cfa:	ea0080e7          	jalr	-352(ra) # 5b96 <exit>
...
0000000000001cfe <reparent2>:
{
    ...
    1d10:	e82080e7          	jalr	-382(ra) # 5b8e <fork>
    if(pid1 < 0){
    ...
    1d20:	e82080e7          	jalr	-382(ra) # 5b9e <wait>
  for(int i = 0; i < 800; i++){
  ...
  exit(0);
    ...
    1d2e:	e6c080e7          	jalr	-404(ra) # 5b96 <exit>
      printf("fork failed\n");
    ...
    1d48:	e52080e7          	jalr	-430(ra) # 5b96 <exit>
      fork();
    1d4c:	00004097          	auipc	ra,0x4
    1d50:	e42080e7          	jalr	-446(ra) # 5b8e <fork>
      fork();
    1d54:	00004097          	auipc	ra,0x4
    1d58:	e3a080e7          	jalr	-454(ra) # 5b8e <fork>
      exit(0);
    1d5c:	4501                	li	a0,0
    1d5e:	00004097          	auipc	ra,0x4
    1d62:	e38080e7          	jalr	-456(ra) # 5b96 <exit>
...
0000000000001d66 <createdelete>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1d8a:	e08080e7          	jalr	-504(ra) # 5b8e <fork>
    1d8e:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    1da6:	dfc080e7          	jalr	-516(ra) # 5b9e <wait>
    if(xstatus != 0)
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1de6:	db4080e7          	jalr	-588(ra) # 5b96 <exit>
      name[0] = 'p' + pi;
    ...
    1e12:	d88080e7          	jalr	-632(ra) # 5b96 <exit>
      for(i = 0; i < N; i++){
    ...
    1e30:	daa080e7          	jalr	-598(ra) # 5bd6 <open>
        if(fd < 0){
    1e34:	fc0543e3          	bltz	a0,1dfa <createdelete+0x94>
        close(fd);
    1e38:	00004097          	auipc	ra,0x4
    1e3c:	d86080e7          	jalr	-634(ra) # 5bbe <close>
        if(i > 0 && (i % 2 ) == 0){
    ...
    1e64:	d86080e7          	jalr	-634(ra) # 5be6 <unlink>
    ...
    1e84:	d16080e7          	jalr	-746(ra) # 5b96 <exit>
      exit(0);
    1e88:	4501                	li	a0,0
    1e8a:	00004097          	auipc	ra,0x4
    1e8e:	d0c080e7          	jalr	-756(ra) # 5b96 <exit>
      exit(1);
    1e92:	4505                	li	a0,1
    1e94:	00004097          	auipc	ra,0x4
    1e98:	d02080e7          	jalr	-766(ra) # 5b96 <exit>
    ...
    1eb8:	ce2080e7          	jalr	-798(ra) # 5b96 <exit>
      } else if((i >= 1 && i < N/2) && fd >= 0){
    ...
    1ee0:	cfa080e7          	jalr	-774(ra) # 5bd6 <open>
      if((i == 0 || i >= N/2) && fd < 0){
    ...
    1ef8:	cca080e7          	jalr	-822(ra) # 5bbe <close>
    ...
    1f1e:	c7c080e7          	jalr	-900(ra) # 5b96 <exit>
  for(i = 0; i < N; i++){
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1f58:	c92080e7          	jalr	-878(ra) # 5be6 <unlink>
    for(pi = 0; pi < NCHILD; pi++){
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb4:	c36080e7          	jalr	-970(ra) # 5be6 <unlink>
  pid = fork();
    1fb8:	00004097          	auipc	ra,0x4
    1fbc:	bd6080e7          	jalr	-1066(ra) # 5b8e <fork>
  if(pid < 0){
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    200e:	b8c080e7          	jalr	-1140(ra) # 5b96 <exit>
      close(open("x", O_RDWR | O_CREATE));
    2012:	20200593          	li	a1,514
    2016:	8556                	mv	a0,s5
    2018:	00004097          	auipc	ra,0x4
    201c:	bbe080e7          	jalr	-1090(ra) # 5bd6 <open>
    2020:	00004097          	auipc	ra,0x4
    2024:	b9e080e7          	jalr	-1122(ra) # 5bbe <close>
  for(i = 0; i < 100; i++){
    ...
    2048:	ba2080e7          	jalr	-1118(ra) # 5be6 <unlink>
    204c:	bff1                	j	2028 <linkunlink+0x9c>
      link("cat", "x");
    204e:	85d6                	mv	a1,s5
    2050:	855e                	mv	a0,s7
    2052:	00004097          	auipc	ra,0x4
    2056:	ba4080e7          	jalr	-1116(ra) # 5bf6 <link>
  ...
  if(pid)
    ...
    2066:	b3c080e7          	jalr	-1220(ra) # 5b9e <wait>
}
    ...
    208a:	b10080e7          	jalr	-1264(ra) # 5b96 <exit>
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20a8:	aea080e7          	jalr	-1302(ra) # 5b8e <fork>
    if(pid < 0)
  ...
  for(n=0; n<N; n++){
    ...
    20d0:	aca080e7          	jalr	-1334(ra) # 5b96 <exit>
      exit(0);
    20d4:	00004097          	auipc	ra,0x4
    20d8:	ac2080e7          	jalr	-1342(ra) # 5b96 <exit>
  if (n == 0) {
  ...
  for(; n > 0; n--){
    ...
    20f0:	ab2080e7          	jalr	-1358(ra) # 5b9e <wait>
  ...
  if(wait(0) != -1){
    ...
    2102:	aa0080e7          	jalr	-1376(ra) # 5b9e <wait>
    2106:	57fd                	li	a5,-1
    ...
    2132:	a68080e7          	jalr	-1432(ra) # 5b96 <exit>
    ...
    214e:	a4c080e7          	jalr	-1460(ra) # 5b96 <exit>
    ...
    216a:	a30080e7          	jalr	-1488(ra) # 5b96 <exit>
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    219c:	9f6080e7          	jalr	-1546(ra) # 5b8e <fork>
    if(pid < 0){
    ...
    21ae:	9f4080e7          	jalr	-1548(ra) # 5b9e <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21ea:	9b0080e7          	jalr	-1616(ra) # 5b96 <exit>
    ...
    220c:	98e080e7          	jalr	-1650(ra) # 5b96 <exit>
      exit(1);
    2210:	4505                	li	a0,1
    2212:	00004097          	auipc	ra,0x4
    2216:	984080e7          	jalr	-1660(ra) # 5b96 <exit>
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    223c:	956080e7          	jalr	-1706(ra) # 5b8e <fork>
    if(pid < 0){
    ...
    224e:	954080e7          	jalr	-1708(ra) # 5b9e <wait>
    if(xstatus != -1)  // did kernel kill child?
  ...
  for( ; a != 0; a <<= 1){
    ...
    228e:	90c080e7          	jalr	-1780(ra) # 5b96 <exit>
      *(char*)a = 99;
    ...
    22ba:	8e0080e7          	jalr	-1824(ra) # 5b96 <exit>
      exit(1);
    22be:	4505                	li	a0,1
    22c0:	00004097          	auipc	ra,0x4
    22c4:	8d6080e7          	jalr	-1834(ra) # 5b96 <exit>
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22e0:	90a080e7          	jalr	-1782(ra) # 5be6 <unlink>
  pid = fork();
    22e4:	00004097          	auipc	ra,0x4
    22e8:	8aa080e7          	jalr	-1878(ra) # 5b8e <fork>
  if(pid == 0){
  ...
  wait(&xstatus);
    ...
    22fa:	8a8080e7          	jalr	-1880(ra) # 5b9e <wait>
  if(xstatus != 0)
  ...
  fd = open("bigarg-ok", 0);
    ...
    2312:	8c8080e7          	jalr	-1848(ra) # 5bd6 <open>
  if(fd < 0){
    2316:	08054e63          	bltz	a0,23b2 <bigargtest+0xea>
  close(fd);
    231a:	00004097          	auipc	ra,0x4
    231e:	8a4080e7          	jalr	-1884(ra) # 5bbe <close>
}
    ...
    2364:	86e080e7          	jalr	-1938(ra) # 5bce <exec>
    ...
    2378:	862080e7          	jalr	-1950(ra) # 5bd6 <open>
    close(fd);
    237c:	00004097          	auipc	ra,0x4
    2380:	842080e7          	jalr	-1982(ra) # 5bbe <close>
    exit(0);
    2384:	4501                	li	a0,0
    2386:	00004097          	auipc	ra,0x4
    238a:	810080e7          	jalr	-2032(ra) # 5b96 <exit>
    ...
    23a6:	7f4080e7          	jalr	2036(ra) # 5b96 <exit>
    exit(xstatus);
    23aa:	00003097          	auipc	ra,0x3
    23ae:	7ec080e7          	jalr	2028(ra) # 5b96 <exit>
    ...
    23ca:	7d0080e7          	jalr	2000(ra) # 5b96 <exit>
...
00000000000023ce <stacktest>:
{
  ...
  pid = fork();
    ...
    23de:	7b4080e7          	jalr	1972(ra) # 5b8e <fork>
  if(pid == 0) {
  ...
  wait(&xstatus);
    ...
    23f0:	7b2080e7          	jalr	1970(ra) # 5b9e <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    2402:	798080e7          	jalr	1944(ra) # 5b96 <exit>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2428:	772080e7          	jalr	1906(ra) # 5b96 <exit>
    printf("%s: fork failed\n", s);
    242c:	85a6                	mv	a1,s1
    ...
    2444:	756080e7          	jalr	1878(ra) # 5b96 <exit>
    exit(0);
    2448:	4501                	li	a0,0
    244a:	00003097          	auipc	ra,0x3
    244e:	74c080e7          	jalr	1868(ra) # 5b96 <exit>
...
0000000000002452 <textwrite>:
{
  ...
  pid = fork();
    ...
    2462:	730080e7          	jalr	1840(ra) # 5b8e <fork>
  if(pid == 0) {
  ...
  wait(&xstatus);
    ...
    2474:	72e080e7          	jalr	1838(ra) # 5b9e <wait>
  if(xstatus == -1)  // kernel killed child?
    ...
    2486:	714080e7          	jalr	1812(ra) # 5b96 <exit>
    *addr = 10;
    248a:	47a9                	li	a5,10
    ...
    2496:	704080e7          	jalr	1796(ra) # 5b96 <exit>
    printf("%s: fork failed\n", s);
    249a:	85a6                	mv	a1,s1
    ...
    24b2:	6e8080e7          	jalr	1768(ra) # 5b96 <exit>
    exit(0);
    24b6:	4501                	li	a0,0
    24b8:	00003097          	auipc	ra,0x3
    24bc:	6de080e7          	jalr	1758(ra) # 5b96 <exit>
...
00000000000024c0 <manywrites>:
{
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    24e0:	6b2080e7          	jalr	1714(ra) # 5b8e <fork>
    24e4:	84aa                	mv	s1,a0
    if(pid < 0){
  ...
  for(int ci = 0; ci < nchildren; ci++){
    ...
    2500:	6a2080e7          	jalr	1698(ra) # 5b9e <wait>
    if(st != 0)
  ...
  exit(0);
    ...
    2514:	686080e7          	jalr	1670(ra) # 5b96 <exit>
      printf("fork failed\n");
    ...
    252e:	66c080e7          	jalr	1644(ra) # 5b96 <exit>
      name[0] = 'b';
    ...
    254e:	69c080e7          	jalr	1692(ra) # 5be6 <unlink>
    2552:	4bf9                	li	s7,30
          int cc = write(fd, buf, sz);
    ...
    256e:	66c080e7          	jalr	1644(ra) # 5bd6 <open>
    2572:	892a                	mv	s2,a0
          if(fd < 0){
    ...
    2580:	63a080e7          	jalr	1594(ra) # 5bb6 <write>
          if(cc != sz){
    ...
    2590:	632080e7          	jalr	1586(ra) # 5bbe <close>
        for(int i = 0; i < ci+1; i++){
    ...
    25a2:	648080e7          	jalr	1608(ra) # 5be6 <unlink>
    ...
    25b4:	636080e7          	jalr	1590(ra) # 5be6 <unlink>
      exit(0);
    25b8:	4501                	li	a0,0
    25ba:	00003097          	auipc	ra,0x3
    25be:	5dc080e7          	jalr	1500(ra) # 5b96 <exit>
    ...
    25de:	5bc080e7          	jalr	1468(ra) # 5b96 <exit>
            printf("%s: write(%d) ret %d\n", s, sz, cc);
    25e2:	86aa                	mv	a3,a0
    ...
    25fe:	59c080e7          	jalr	1436(ra) # 5b96 <exit>
      exit(st);
    2602:	00003097          	auipc	ra,0x3
    2606:	594080e7          	jalr	1428(ra) # 5b96 <exit>
...
000000000000260a <copyinstr3>:
{
  ...
  sbrk(8192);
    ...
    261a:	608080e7          	jalr	1544(ra) # 5c1e <sbrk>
  uint64 top = (uint64) sbrk(0);
    261e:	4501                	li	a0,0
    2620:	00003097          	auipc	ra,0x3
    2624:	5fe080e7          	jalr	1534(ra) # 5c1e <sbrk>
  if((top % PGSIZE) != 0){
  ...
  top = (uint64) sbrk(0);
    ...
    2634:	5ee080e7          	jalr	1518(ra) # 5c1e <sbrk>
  if(top % PGSIZE){
  ...
  *b = 'x';
  ...
  int ret = unlink(b);
    ...
    2650:	59a080e7          	jalr	1434(ra) # 5be6 <unlink>
  if(ret != -1){
    2654:	57fd                	li	a5,-1
  ...
  int fd = open(b, O_CREATE | O_WRONLY);
    ...
    2664:	576080e7          	jalr	1398(ra) # 5bd6 <open>
  if(fd != -1){
    2668:	57fd                	li	a5,-1
  ...
  ret = link(b, b);
    ...
    2676:	584080e7          	jalr	1412(ra) # 5bf6 <link>
  if(ret != -1){
    267a:	57fd                	li	a5,-1
  ...
  ret = exec(b, args);
    ...
    269a:	538080e7          	jalr	1336(ra) # 5bce <exec>
  if(ret != -1){
    269e:	57fd                	li	a5,-1
    ...
    26bc:	566080e7          	jalr	1382(ra) # 5c1e <sbrk>
    ...
    26d8:	4c2080e7          	jalr	1218(ra) # 5b96 <exit>
    printf("unlink(%s) returned %d, not -1\n", b, ret);
    26dc:	862a                	mv	a2,a0
    26de:	85a6                	mv	a1,s1
    ...
    26f6:	4a4080e7          	jalr	1188(ra) # 5b96 <exit>
    printf("open(%s) returned %d, not -1\n", b, fd);
    26fa:	862a                	mv	a2,a0
    26fc:	85a6                	mv	a1,s1
    ...
    2714:	486080e7          	jalr	1158(ra) # 5b96 <exit>
    printf("link(%s, %s) returned %d, not -1\n", b, b, ret);
    2718:	86aa                	mv	a3,a0
    271a:	8626                	mv	a2,s1
    271c:	85a6                	mv	a1,s1
    ...
    2734:	466080e7          	jalr	1126(ra) # 5b96 <exit>
    printf("exec(%s) returned %d, not -1\n", b, fd);
    2738:	567d                	li	a2,-1
    273a:	85a6                	mv	a1,s1
    ...
    2752:	448080e7          	jalr	1096(ra) # 5b96 <exit>
...
0000000000002756 <rwsbrk>:
{
  ...
  uint64 a = (uint64) sbrk(8192);
    ...
    2768:	4ba080e7          	jalr	1210(ra) # 5c1e <sbrk>
  ...
  if ((uint64) sbrk(-8192) ==  0xffffffffffffffffLL) {
    ...
    277a:	4a8080e7          	jalr	1192(ra) # 5c1e <sbrk>
    277e:	57fd                	li	a5,-1
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2794:	446080e7          	jalr	1094(ra) # 5bd6 <open>
    2798:	892a                	mv	s2,a0
  if(fd < 0){
  ...
  n = write(fd, (void*)(a+4096), 1024);
    ...
    27ac:	40e080e7          	jalr	1038(ra) # 5bb6 <write>
    27b0:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    27ce:	3cc080e7          	jalr	972(ra) # 5b96 <exit>
    ...
    27e8:	3b2080e7          	jalr	946(ra) # 5b96 <exit>
    ...
    2802:	398080e7          	jalr	920(ra) # 5b96 <exit>
  ...
  n = read(fd, (void*)(a+4096), 10);
    ...
    285a:	358080e7          	jalr	856(ra) # 5bae <read>
    285e:	862a                	mv	a2,a0
  if(n >= 0){
    ...
    287c:	31e080e7          	jalr	798(ra) # 5b96 <exit>
    printf("open(rwsbrk) failed\n");
    ...
    2896:	304080e7          	jalr	772(ra) # 5b96 <exit>
  close(fd);
    289a:	854a                	mv	a0,s2
    289c:	00003097          	auipc	ra,0x3
    28a0:	322080e7          	jalr	802(ra) # 5bbe <close>
  exit(0);
    28a4:	4501                	li	a0,0
    28a6:	00003097          	auipc	ra,0x3
    28aa:	2f0080e7          	jalr	752(ra) # 5b96 <exit>
...
00000000000028ae <sbrkbasic>:
{
  ...
  pid = fork();
    ...
    28c4:	2ce080e7          	jalr	718(ra) # 5b8e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    28d6:	34c080e7          	jalr	844(ra) # 5c1e <sbrk>
    ...
    28fc:	29e080e7          	jalr	670(ra) # 5b96 <exit>
    ...
    2916:	284080e7          	jalr	644(ra) # 5b96 <exit>
      exit(0);
    291a:	4501                	li	a0,0
    291c:	00003097          	auipc	ra,0x3
    2920:	27a080e7          	jalr	634(ra) # 5b96 <exit>
  wait(&xstatus);
    2924:	fcc40513          	addi	a0,s0,-52
    2928:	00003097          	auipc	ra,0x3
    292c:	276080e7          	jalr	630(ra) # 5b9e <wait>
  if(xstatus == 1){
  ...
  a = sbrk(0);
    ...
    2940:	2e2080e7          	jalr	738(ra) # 5c1e <sbrk>
    2944:	84aa                	mv	s1,a0
  for(i = 0; i < 5000; i++){
    2946:	4901                	li	s2,0
    ...
    2968:	232080e7          	jalr	562(ra) # 5b96 <exit>
    a = b + 1;
    296c:	84be                	mv	s1,a5
    b = sbrk(1);
    296e:	4505                	li	a0,1
    2970:	00003097          	auipc	ra,0x3
    2974:	2ae080e7          	jalr	686(ra) # 5c1e <sbrk>
    if(b != a){
  ...
  pid = fork();
    ...
    2990:	202080e7          	jalr	514(ra) # 5b8e <fork>
    2994:	892a                	mv	s2,a0
  if(pid < 0){
  ...
  c = sbrk(1);
    ...
    29a0:	282080e7          	jalr	642(ra) # 5c1e <sbrk>
  c = sbrk(1);
    29a4:	4505                	li	a0,1
    29a6:	00003097          	auipc	ra,0x3
    29aa:	278080e7          	jalr	632(ra) # 5c1e <sbrk>
  if(c != a + 1){
    ...
    29cc:	1ce080e7          	jalr	462(ra) # 5b96 <exit>
    ...
    29ee:	1ac080e7          	jalr	428(ra) # 5b96 <exit>
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    ...
    2aa0:	182080e7          	jalr	386(ra) # 5c1e <sbrk>
    2aa4:	84aa                	mv	s1,a0
  c = sbrk(-PGSIZE);
    2aa6:	757d                	lui	a0,0xfffff
    2aa8:	00003097          	auipc	ra,0x3
    2aac:	176080e7          	jalr	374(ra) # 5c1e <sbrk>
  ...
  c = sbrk(0);
    ...
    2abc:	166080e7          	jalr	358(ra) # 5c1e <sbrk>
  if(c != a - PGSIZE){
  ...
  a = sbrk(0);
    ...
    2b0c:	116080e7          	jalr	278(ra) # 5c1e <sbrk>
    2b10:	84aa                	mv	s1,a0
  c = sbrk(-(sbrk(0) - oldbrk));
    2b12:	4501                	li	a0,0
    2b14:	00003097          	auipc	ra,0x3
    2b18:	10a080e7          	jalr	266(ra) # 5c1e <sbrk>
    2b1c:	40a9053b          	subw	a0,s2,a0
    2b20:	00003097          	auipc	ra,0x3
    2b24:	0fe080e7          	jalr	254(ra) # 5c1e <sbrk>
  if(c != a){
    ...
    2b54:	046080e7          	jalr	70(ra) # 5b96 <exit>
    ...
    2b70:	02a080e7          	jalr	42(ra) # 5b96 <exit>
    ...
    2b90:	00a080e7          	jalr	10(ra) # 5b96 <exit>
    ...
    2bb0:	fea080e7          	jalr	-22(ra) # 5b96 <exit>
    ...
    2bcc:	fce080e7          	jalr	-50(ra) # 5b96 <exit>
    ...
    2bec:	fae080e7          	jalr	-82(ra) # 5b96 <exit>
...
0000000000002bf0 <sbrkarg>:
{
  ...
  a = sbrk(PGSIZE);
    ...
    2c06:	01c080e7          	jalr	28(ra) # 5c1e <sbrk>
    2c0a:	892a                	mv	s2,a0
  ...
  if ((n = write(fd, a, PGSIZE)) < 0) {
    ...
    2c40:	f7a080e7          	jalr	-134(ra) # 5bb6 <write>
    2c44:	04054663          	bltz	a0,2c90 <sbrkarg+0xa0>
  close(fd);
    2c48:	8526                	mv	a0,s1
    2c4a:	00003097          	auipc	ra,0x3
    2c4e:	f74080e7          	jalr	-140(ra) # 5bbe <close>
  a = sbrk(PGSIZE);
    2c52:	6505                	lui	a0,0x1
    2c54:	00003097          	auipc	ra,0x3
    2c58:	fca080e7          	jalr	-54(ra) # 5c1e <sbrk>
  if(pipe((int *) a) != 0){
    2c5c:	00003097          	auipc	ra,0x3
    2c60:	f4a080e7          	jalr	-182(ra) # 5ba6 <pipe>
    ...
    2c8c:	f0e080e7          	jalr	-242(ra) # 5b96 <exit>
    ...
    2ca8:	ef2080e7          	jalr	-270(ra) # 5b96 <exit>
    printf("%s: pipe() failed\n", s);
    2cac:	85ce                	mv	a1,s3
    ...
    2cc4:	ed6080e7          	jalr	-298(ra) # 5b96 <exit>
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce4:	ef6080e7          	jalr	-266(ra) # 5bd6 <open>
  if (fd < 0) {
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    2cf4:	f2e080e7          	jalr	-210(ra) # 5c1e <sbrk>
    2cf8:	567d                	li	a2,-1
    2cfa:	fff50593          	addi	a1,a0,-1
    2cfe:	8526                	mv	a0,s1
    2d00:	00003097          	auipc	ra,0x3
    2d04:	eae080e7          	jalr	-338(ra) # 5bae <read>
  close(fd);
    2d08:	8526                	mv	a0,s1
    2d0a:	00003097          	auipc	ra,0x3
    2d0e:	eb4080e7          	jalr	-332(ra) # 5bbe <close>
}
    ...
    2d36:	e64080e7          	jalr	-412(ra) # 5b96 <exit>
...
0000000000002d3a <sbrkbugs>:
{
  ...
  int pid = fork();
    ...
    2d46:	e4c080e7          	jalr	-436(ra) # 5b8e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2d54:	ece080e7          	jalr	-306(ra) # 5c1e <sbrk>
    sbrk(-sz);
    2d58:	40a0053b          	negw	a0,a0
    2d5c:	00003097          	auipc	ra,0x3
    2d60:	ec2080e7          	jalr	-318(ra) # 5c1e <sbrk>
    exit(0);
    2d64:	4501                	li	a0,0
    2d66:	00003097          	auipc	ra,0x3
    2d6a:	e30080e7          	jalr	-464(ra) # 5b96 <exit>
    printf("fork failed\n");
    ...
    2d84:	e16080e7          	jalr	-490(ra) # 5b96 <exit>
  wait(0);
    2d88:	4501                	li	a0,0
    2d8a:	00003097          	auipc	ra,0x3
    2d8e:	e14080e7          	jalr	-492(ra) # 5b9e <wait>
  pid = fork();
    2d92:	00003097          	auipc	ra,0x3
    2d96:	dfc080e7          	jalr	-516(ra) # 5b8e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2da4:	e7e080e7          	jalr	-386(ra) # 5c1e <sbrk>
    sbrk(-(sz - 3500));
    ...
    2db6:	e6c080e7          	jalr	-404(ra) # 5c1e <sbrk>
    exit(0);
    2dba:	4501                	li	a0,0
    2dbc:	00003097          	auipc	ra,0x3
    2dc0:	dda080e7          	jalr	-550(ra) # 5b96 <exit>
    printf("fork failed\n");
    ...
    2dda:	dc0080e7          	jalr	-576(ra) # 5b96 <exit>
  wait(0);
    2dde:	4501                	li	a0,0
    2de0:	00003097          	auipc	ra,0x3
    2de4:	dbe080e7          	jalr	-578(ra) # 5b9e <wait>
  pid = fork();
    2de8:	00003097          	auipc	ra,0x3
    2dec:	da6080e7          	jalr	-602(ra) # 5b8e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    2dfa:	e28080e7          	jalr	-472(ra) # 5c1e <sbrk>
    ...
    2e0c:	e16080e7          	jalr	-490(ra) # 5c1e <sbrk>
    sbrk(-10);
    2e10:	5559                	li	a0,-10
    2e12:	00003097          	auipc	ra,0x3
    2e16:	e0c080e7          	jalr	-500(ra) # 5c1e <sbrk>
    exit(0);
    2e1a:	4501                	li	a0,0
    2e1c:	00003097          	auipc	ra,0x3
    2e20:	d7a080e7          	jalr	-646(ra) # 5b96 <exit>
    printf("fork failed\n");
    ...
    2e3a:	d60080e7          	jalr	-672(ra) # 5b96 <exit>
  wait(0);
    2e3e:	4501                	li	a0,0
    2e40:	00003097          	auipc	ra,0x3
    2e44:	d5e080e7          	jalr	-674(ra) # 5b9e <wait>
  exit(0);
    2e48:	4501                	li	a0,0
    2e4a:	00003097          	auipc	ra,0x3
    2e4e:	d4c080e7          	jalr	-692(ra) # 5b96 <exit>
...
0000000000002e52 <sbrklast>:
{
  ...
  uint64 top = (uint64) sbrk(0);
    ...
    2e68:	dba080e7          	jalr	-582(ra) # 5c1e <sbrk>
  if((top % 4096) != 0)
  ...
  sbrk(4096);
    ...
    2e78:	daa080e7          	jalr	-598(ra) # 5c1e <sbrk>
  sbrk(10);
    2e7c:	4529                	li	a0,10
    2e7e:	00003097          	auipc	ra,0x3
    2e82:	da0080e7          	jalr	-608(ra) # 5c1e <sbrk>
  sbrk(-20);
    2e86:	5531                	li	a0,-20
    2e88:	00003097          	auipc	ra,0x3
    2e8c:	d96080e7          	jalr	-618(ra) # 5c1e <sbrk>
  top = (uint64) sbrk(0);
    2e90:	4501                	li	a0,0
    2e92:	00003097          	auipc	ra,0x3
    2e96:	d8c080e7          	jalr	-628(ra) # 5c1e <sbrk>
    2e9a:	84aa                	mv	s1,a0
  char *p = (char *) (top - 64);
  ...
  int fd = open(p, O_RDWR|O_CREATE);
    ...
    2eb6:	d24080e7          	jalr	-732(ra) # 5bd6 <open>
    2eba:	89aa                	mv	s3,a0
  write(fd, p, 1);
    2ebc:	4605                	li	a2,1
    2ebe:	85ca                	mv	a1,s2
    2ec0:	00003097          	auipc	ra,0x3
    2ec4:	cf6080e7          	jalr	-778(ra) # 5bb6 <write>
  close(fd);
    2ec8:	854e                	mv	a0,s3
    2eca:	00003097          	auipc	ra,0x3
    2ece:	cf4080e7          	jalr	-780(ra) # 5bbe <close>
  fd = open(p, O_RDWR);
    2ed2:	4589                	li	a1,2
    2ed4:	854a                	mv	a0,s2
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	d00080e7          	jalr	-768(ra) # 5bd6 <open>
  p[0] = '\0';
  ...
  read(fd, p, 1);
    ...
    2eea:	cc8080e7          	jalr	-824(ra) # 5bae <read>
  if(p[0] != 'x')
    ...
    2f14:	d0e080e7          	jalr	-754(ra) # 5c1e <sbrk>
    2f18:	bfa9                	j	2e72 <sbrklast+0x20>
    exit(1);
    2f1a:	4505                	li	a0,1
    2f1c:	00003097          	auipc	ra,0x3
    2f20:	c7a080e7          	jalr	-902(ra) # 5b96 <exit>
...
0000000000002f24 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2f36:	cec080e7          	jalr	-788(ra) # 5c1e <sbrk>
  volatile char *top = sbrk(0);
    2f3a:	4501                	li	a0,0
    2f3c:	00003097          	auipc	ra,0x3
    2f40:	ce2080e7          	jalr	-798(ra) # 5c1e <sbrk>
  *(top-1) = *(top-1) + 1;
...
0000000000002f5a <execout>:
{
  ...
  for(int avail = 0; avail < 15; avail++){
    ...
    2f72:	c20080e7          	jalr	-992(ra) # 5b8e <fork>
    2f76:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    2f84:	c1e080e7          	jalr	-994(ra) # 5b9e <wait>
  for(int avail = 0; avail < 15; avail++){
  ...
  exit(0);
    ...
    2f94:	c06080e7          	jalr	-1018(ra) # 5b96 <exit>
      printf("fork failed\n");
    ...
    2fae:	bec080e7          	jalr	-1044(ra) # 5b96 <exit>
        if(a == 0xffffffffffffffffLL)
    2fb2:	59fd                	li	s3,-1
        *(char*)(a + 4096 - 1) = 1;
    2fb4:	4a05                	li	s4,1
    ...
    2fbc:	c66080e7          	jalr	-922(ra) # 5c1e <sbrk>
        if(a == 0xffffffffffffffffLL)
    ...
    2fd8:	c4a080e7          	jalr	-950(ra) # 5c1e <sbrk>
      for(int i = 0; i < avail; i++)
    ...
    2fe8:	bda080e7          	jalr	-1062(ra) # 5bbe <close>
      char *args[] = { "echo", "x", 0 };
    ...
    3010:	bc2080e7          	jalr	-1086(ra) # 5bce <exec>
      exit(0);
    3014:	4501                	li	a0,0
    3016:	00003097          	auipc	ra,0x3
    301a:	b80080e7          	jalr	-1152(ra) # 5b96 <exit>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3036:	bcc080e7          	jalr	-1076(ra) # 5bfe <mkdir>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3048:	bba080e7          	jalr	-1094(ra) # 5bfe <mkdir>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30aa:	b58080e7          	jalr	-1192(ra) # 5bfe <mkdir>
  ...
  unlink("12345678901234");
    ...
    3132:	a68080e7          	jalr	-1432(ra) # 5b96 <exit>
    ...
    314e:	a4c080e7          	jalr	-1460(ra) # 5b96 <exit>
    ...
    316a:	a30080e7          	jalr	-1488(ra) # 5b96 <exit>
    ...
    3186:	a14080e7          	jalr	-1516(ra) # 5b96 <exit>
    ...
    31a2:	9f8080e7          	jalr	-1544(ra) # 5b96 <exit>
    ...
    31be:	9dc080e7          	jalr	-1572(ra) # 5b96 <exit>
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    3200:	9ea080e7          	jalr	-1558(ra) # 5be6 <unlink>
  for(fi = 0; done == 0; fi++){
    3204:	4a01                	li	s4,0
    name[0] = 'b';
    ...
    3236:	98c080e7          	jalr	-1652(ra) # 5bbe <close>
    close(fd);
    323a:	854a                	mv	a0,s2
    323c:	00003097          	auipc	ra,0x3
    3240:	982080e7          	jalr	-1662(ra) # 5bbe <close>
  for(fi = 0; done == 0; fi++){
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32ba:	948080e7          	jalr	-1720(ra) # 5bfe <mkdir>
  ...
  unlink("diskfulldir");
    ...
    32ce:	91c080e7          	jalr	-1764(ra) # 5be6 <unlink>
  for(int i = 0; i < nzz; i++){
    32d2:	4481                	li	s1,0
    name[0] = 'z';
  ...
  for(int i = 0; i < nzz; i++){
    ...
    3314:	8d6080e7          	jalr	-1834(ra) # 5be6 <unlink>
  for(int i = 0; i < nzz; i++){
  ...
  for(int i = 0; i < fi; i++){
    ...
    3350:	89a080e7          	jalr	-1894(ra) # 5be6 <unlink>
  for(int i = 0; i < fi; i++){
    ...
    338e:	834080e7          	jalr	-1996(ra) # 5bbe <close>
  for(fi = 0; done == 0; fi++){
    ...
    33de:	7dc080e7          	jalr	2012(ra) # 5bb6 <write>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    341a:	7e8080e7          	jalr	2024(ra) # 5bfe <mkdir>
  ...
  if(chdir("iputdir") < 0){
    ...
    342e:	7dc080e7          	jalr	2012(ra) # 5c06 <chdir>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3442:	7a8080e7          	jalr	1960(ra) # 5be6 <unlink>
  ...
  if(chdir("/") < 0){
    ...
    3456:	7b4080e7          	jalr	1972(ra) # 5c06 <chdir>
    ...
    3480:	71a080e7          	jalr	1818(ra) # 5b96 <exit>
    ...
    349c:	6fe080e7          	jalr	1790(ra) # 5b96 <exit>
    ...
    34b8:	6e2080e7          	jalr	1762(ra) # 5b96 <exit>
    ...
    34d4:	6c6080e7          	jalr	1734(ra) # 5b96 <exit>
...
00000000000034d8 <exitiputtest>:
{
  ...
  pid = fork();
    ...
    34e8:	6aa080e7          	jalr	1706(ra) # 5b8e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    34fe:	704080e7          	jalr	1796(ra) # 5bfe <mkdir>
    ...
    3512:	6f8080e7          	jalr	1784(ra) # 5c06 <chdir>
    ...
    3526:	6c4080e7          	jalr	1732(ra) # 5be6 <unlink>
    352a:	06054163          	bltz	a0,358c <exitiputtest+0xb4>
    exit(0);
    352e:	4501                	li	a0,0
    3530:	00002097          	auipc	ra,0x2
    3534:	666080e7          	jalr	1638(ra) # 5b96 <exit>
    printf("%s: fork failed\n", s);
    3538:	85a6                	mv	a1,s1
    ...
    3550:	64a080e7          	jalr	1610(ra) # 5b96 <exit>
      printf("%s: mkdir failed\n", s);
    3554:	85a6                	mv	a1,s1
    ...
    356c:	62e080e7          	jalr	1582(ra) # 5b96 <exit>
    ...
    3588:	612080e7          	jalr	1554(ra) # 5b96 <exit>
      printf("%s: unlink ../iputdir failed\n", s);
    358c:	85a6                	mv	a1,s1
    ...
    35a4:	5f6080e7          	jalr	1526(ra) # 5b96 <exit>
  wait(&xstatus);
    35a8:	fdc40513          	addi	a0,s0,-36
    35ac:	00002097          	auipc	ra,0x2
    35b0:	5f2080e7          	jalr	1522(ra) # 5b9e <wait>
  exit(xstatus);
    35b4:	fdc42503          	lw	a0,-36(s0)
    35b8:	00002097          	auipc	ra,0x2
    35bc:	5de080e7          	jalr	1502(ra) # 5b96 <exit>
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d8:	62a080e7          	jalr	1578(ra) # 5bfe <mkdir>
  ...
  if(chdir("dir0") < 0){
    ...
    35ec:	61e080e7          	jalr	1566(ra) # 5c06 <chdir>
  ...
  if(chdir("..") < 0){
    ...
    3600:	60a080e7          	jalr	1546(ra) # 5c06 <chdir>
  ...
  if(unlink("dir0") < 0){
    ...
    3614:	5d6080e7          	jalr	1494(ra) # 5be6 <unlink>
    ...
    363e:	55c080e7          	jalr	1372(ra) # 5b96 <exit>
    ...
    365a:	540080e7          	jalr	1344(ra) # 5b96 <exit>
    printf("%s: chdir .. failed\n", s);
    365e:	85a6                	mv	a1,s1
    ...
    3676:	524080e7          	jalr	1316(ra) # 5b96 <exit>
    ...
    3692:	508080e7          	jalr	1288(ra) # 5b96 <exit>
...
0000000000003696 <subdir>:
{
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d8:	502080e7          	jalr	1282(ra) # 5bd6 <open>
    36dc:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371e:	4e4080e7          	jalr	1252(ra) # 5bfe <mkdir>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3736:	4a4080e7          	jalr	1188(ra) # 5bd6 <open>
    373a:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    3782:	430080e7          	jalr	1072(ra) # 5bae <read>
  if(cc != 2 || buf[0] != 'f'){
    3786:	4789                	li	a5,2
  ...
  close(fd);
    ...
    37a2:	420080e7          	jalr	1056(ra) # 5bbe <close>
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37ba:	440080e7          	jalr	1088(ra) # 5bf6 <link>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37ce:	41c080e7          	jalr	1052(ra) # 5be6 <unlink>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e4:	3f6080e7          	jalr	1014(ra) # 5bd6 <open>
  ...
  if(chdir("dd") != 0){
    ...
    37f8:	412080e7          	jalr	1042(ra) # 5c06 <chdir>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380c:	3fe080e7          	jalr	1022(ra) # 5c06 <chdir>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3820:	3ea080e7          	jalr	1002(ra) # 5c06 <chdir>
  ...
  if(chdir("./..") != 0){
    ...
    3834:	3d6080e7          	jalr	982(ra) # 5c06 <chdir>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    384a:	390080e7          	jalr	912(ra) # 5bd6 <open>
    384e:	84aa                	mv	s1,a0
  if(fd < 0){
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389c:	33e080e7          	jalr	830(ra) # 5bd6 <open>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b4:	326080e7          	jalr	806(ra) # 5bd6 <open>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38cc:	30e080e7          	jalr	782(ra) # 5bd6 <open>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e2:	2f8080e7          	jalr	760(ra) # 5bd6 <open>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f8:	2e2080e7          	jalr	738(ra) # 5bd6 <open>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3914:	2e6080e7          	jalr	742(ra) # 5bf6 <link>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3930:	2ca080e7          	jalr	714(ra) # 5bf6 <link>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    394c:	2ae080e7          	jalr	686(ra) # 5bf6 <link>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3960:	2a2080e7          	jalr	674(ra) # 5bfe <mkdir>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3974:	28e080e7          	jalr	654(ra) # 5bfe <mkdir>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3988:	27a080e7          	jalr	634(ra) # 5bfe <mkdir>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399c:	24e080e7          	jalr	590(ra) # 5be6 <unlink>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39b0:	23a080e7          	jalr	570(ra) # 5be6 <unlink>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c4:	246080e7          	jalr	582(ra) # 5c06 <chdir>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d8:	232080e7          	jalr	562(ra) # 5c06 <chdir>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ec:	1fe080e7          	jalr	510(ra) # 5be6 <unlink>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3a00:	1ea080e7          	jalr	490(ra) # 5be6 <unlink>
  ...
  if(unlink("dd") == 0){
    ...
    3a14:	1d6080e7          	jalr	470(ra) # 5be6 <unlink>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a28:	1c2080e7          	jalr	450(ra) # 5be6 <unlink>
  ...
  if(unlink("dd") < 0){
    ...
    3a3c:	1ae080e7          	jalr	430(ra) # 5be6 <unlink>
    ...
    3a68:	132080e7          	jalr	306(ra) # 5b96 <exit>
    ...
    3a84:	116080e7          	jalr	278(ra) # 5b96 <exit>
    ...
    3aa0:	0fa080e7          	jalr	250(ra) # 5b96 <exit>
    ...
    3abc:	0de080e7          	jalr	222(ra) # 5b96 <exit>
    ...
    3ad8:	0c2080e7          	jalr	194(ra) # 5b96 <exit>
    ...
    3af4:	0a6080e7          	jalr	166(ra) # 5b96 <exit>
    ...
    3b10:	08a080e7          	jalr	138(ra) # 5b96 <exit>
    ...
    3b2c:	06e080e7          	jalr	110(ra) # 5b96 <exit>
    ...
    3b48:	052080e7          	jalr	82(ra) # 5b96 <exit>
    ...
    3b64:	036080e7          	jalr	54(ra) # 5b96 <exit>
    ...
    3b80:	01a080e7          	jalr	26(ra) # 5b96 <exit>
    ...
    3b9c:	ffe080e7          	jalr	-2(ra) # 5b96 <exit>
    ...
    3bb8:	fe2080e7          	jalr	-30(ra) # 5b96 <exit>
    printf("%s: chdir ./.. failed\n", s);
    3bbc:	85ca                	mv	a1,s2
    ...
    3bd4:	fc6080e7          	jalr	-58(ra) # 5b96 <exit>
    ...
    3bf0:	faa080e7          	jalr	-86(ra) # 5b96 <exit>
    ...
    3c0c:	f8e080e7          	jalr	-114(ra) # 5b96 <exit>
    printf("%s: open (unlinked) dd/dd/ff succeeded!\n", s);
    3c10:	85ca                	mv	a1,s2
    ...
    3c28:	f72080e7          	jalr	-142(ra) # 5b96 <exit>
    ...
    3c44:	f56080e7          	jalr	-170(ra) # 5b96 <exit>
    ...
    3c60:	f3a080e7          	jalr	-198(ra) # 5b96 <exit>
    ...
    3c7c:	f1e080e7          	jalr	-226(ra) # 5b96 <exit>
    ...
    3c98:	f02080e7          	jalr	-254(ra) # 5b96 <exit>
    ...
    3cb4:	ee6080e7          	jalr	-282(ra) # 5b96 <exit>
    ...
    3cd0:	eca080e7          	jalr	-310(ra) # 5b96 <exit>
    ...
    3cec:	eae080e7          	jalr	-338(ra) # 5b96 <exit>
    ...
    3d08:	e92080e7          	jalr	-366(ra) # 5b96 <exit>
    ...
    3d24:	e76080e7          	jalr	-394(ra) # 5b96 <exit>
    ...
    3d40:	e5a080e7          	jalr	-422(ra) # 5b96 <exit>
    ...
    3d5c:	e3e080e7          	jalr	-450(ra) # 5b96 <exit>
    ...
    3d78:	e22080e7          	jalr	-478(ra) # 5b96 <exit>
    ...
    3d94:	e06080e7          	jalr	-506(ra) # 5b96 <exit>
    ...
    3db0:	dea080e7          	jalr	-534(ra) # 5b96 <exit>
    ...
    3dcc:	dce080e7          	jalr	-562(ra) # 5b96 <exit>
    printf("%s: unlink dd/dd/ff failed\n", s);
    3dd0:	85ca                	mv	a1,s2
    ...
    3de8:	db2080e7          	jalr	-590(ra) # 5b96 <exit>
    ...
    3e04:	d96080e7          	jalr	-618(ra) # 5b96 <exit>
    ...
    3e20:	d7a080e7          	jalr	-646(ra) # 5b96 <exit>
    ...
    3e3c:	d5e080e7          	jalr	-674(ra) # 5b96 <exit>
    ...
    3e58:	d42080e7          	jalr	-702(ra) # 5b96 <exit>
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e74:	d8e080e7          	jalr	-626(ra) # 5bfe <mkdir>
  ...
  if(chdir("dots") != 0){
    ...
    3e86:	d84080e7          	jalr	-636(ra) # 5c06 <chdir>
  ...
  if(unlink(".") == 0){
    ...
    3e98:	d52080e7          	jalr	-686(ra) # 5be6 <unlink>
  ...
  if(unlink("..") == 0){
    ...
    3eaa:	d40080e7          	jalr	-704(ra) # 5be6 <unlink>
  ...
  if(chdir("/") != 0){
    ...
    3ebc:	d4e080e7          	jalr	-690(ra) # 5c06 <chdir>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ece:	d1c080e7          	jalr	-740(ra) # 5be6 <unlink>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ee0:	d0a080e7          	jalr	-758(ra) # 5be6 <unlink>
  ...
  if(unlink("dots") != 0){
    ...
    3ef2:	cf8080e7          	jalr	-776(ra) # 5be6 <unlink>
    ...
    3f1a:	c80080e7          	jalr	-896(ra) # 5b96 <exit>
    ...
    3f36:	c64080e7          	jalr	-924(ra) # 5b96 <exit>
    printf("%s: rm . worked!\n", s);
    3f3a:	85a6                	mv	a1,s1
    ...
    3f52:	c48080e7          	jalr	-952(ra) # 5b96 <exit>
    printf("%s: rm .. worked!\n", s);
    3f56:	85a6                	mv	a1,s1
    ...
    3f6e:	c2c080e7          	jalr	-980(ra) # 5b96 <exit>
    printf("%s: chdir / failed\n", s);
    3f72:	85a6                	mv	a1,s1
    ...
    3f8a:	c10080e7          	jalr	-1008(ra) # 5b96 <exit>
    ...
    3fa6:	bf4080e7          	jalr	-1036(ra) # 5b96 <exit>
    printf("%s: unlink dots/.. worked!\n", s);
    3faa:	85a6                	mv	a1,s1
    ...
    3fc2:	bd8080e7          	jalr	-1064(ra) # 5b96 <exit>
    ...
    3fde:	bbc080e7          	jalr	-1092(ra) # 5b96 <exit>
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile/xx", 0);
    ...
    4030:	baa080e7          	jalr	-1110(ra) # 5bd6 <open>
  if(fd >= 0){
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4048:	b92080e7          	jalr	-1134(ra) # 5bd6 <open>
  if(fd >= 0){
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405c:	ba6080e7          	jalr	-1114(ra) # 5bfe <mkdir>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4070:	b7a080e7          	jalr	-1158(ra) # 5be6 <unlink>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    408c:	b6e080e7          	jalr	-1170(ra) # 5bf6 <link>
  ...
  if(unlink("dirfile") != 0){
    ...
    40a0:	b4a080e7          	jalr	-1206(ra) # 5be6 <unlink>
  ...
  fd = open(".", O_RDWR);
    ...
    40b6:	b24080e7          	jalr	-1244(ra) # 5bd6 <open>
  if(fd >= 0){
  ...
  fd = open(".", 0);
    ...
    40cc:	b0e080e7          	jalr	-1266(ra) # 5bd6 <open>
    40d0:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    40d2:	4605                	li	a2,1
    ...
    40e0:	ada080e7          	jalr	-1318(ra) # 5bb6 <write>
    40e4:	10a04b63          	bgtz	a0,41fa <dirfile+0x218>
  close(fd);
    40e8:	8526                	mv	a0,s1
    40ea:	00002097          	auipc	ra,0x2
    40ee:	ad4080e7          	jalr	-1324(ra) # 5bbe <close>
}
    ...
    4116:	a84080e7          	jalr	-1404(ra) # 5b96 <exit>
    ...
    4132:	a68080e7          	jalr	-1432(ra) # 5b96 <exit>
    ...
    414e:	a4c080e7          	jalr	-1460(ra) # 5b96 <exit>
    printf("%s: create dirfile/xx succeeded!\n", s);
    4152:	85ca                	mv	a1,s2
    ...
    416a:	a30080e7          	jalr	-1488(ra) # 5b96 <exit>
    ...
    4186:	a14080e7          	jalr	-1516(ra) # 5b96 <exit>
    ...
    41a2:	9f8080e7          	jalr	-1544(ra) # 5b96 <exit>
    ...
    41be:	9dc080e7          	jalr	-1572(ra) # 5b96 <exit>
    ...
    41da:	9c0080e7          	jalr	-1600(ra) # 5b96 <exit>
    ...
    41f6:	9a4080e7          	jalr	-1628(ra) # 5b96 <exit>
    ...
    4212:	988080e7          	jalr	-1656(ra) # 5b96 <exit>
...
0000000000004216 <iref>:
{
    ...
    426a:	930080e7          	jalr	-1744(ra) # 5b96 <exit>
    ...
    4286:	914080e7          	jalr	-1772(ra) # 5b96 <exit>
      close(fd);
    428a:	00002097          	auipc	ra,0x2
    428e:	934080e7          	jalr	-1740(ra) # 5bbe <close>
    4292:	a889                	j	42e4 <iref+0xce>
    unlink("xx");
    4294:	854e                	mv	a0,s3
    4296:	00002097          	auipc	ra,0x2
    429a:	950080e7          	jalr	-1712(ra) # 5be6 <unlink>
  for(i = 0; i < NINODE + 1; i++){
    ...
    42ee:	8ec080e7          	jalr	-1812(ra) # 5bd6 <open>
    if(fd >= 0)
    42f2:	fa0541e3          	bltz	a0,4294 <iref+0x7e>
      close(fd);
    42f6:	00002097          	auipc	ra,0x2
    42fa:	8c8080e7          	jalr	-1848(ra) # 5bbe <close>
    ...
    431a:	8f0080e7          	jalr	-1808(ra) # 5c06 <chdir>
    unlink("irefd");
    431e:	854a                	mv	a0,s2
    4320:	00002097          	auipc	ra,0x2
    4324:	8c6080e7          	jalr	-1850(ra) # 5be6 <unlink>
  for(i = 0; i < NINODE + 1; i++){
  ...
  chdir("/");
    ...
    4338:	8d2080e7          	jalr	-1838(ra) # 5c06 <chdir>
}
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4368:	89a080e7          	jalr	-1894(ra) # 5bfe <mkdir>
    436c:	04054263          	bltz	a0,43b0 <openiputtest+0x60>
  pid = fork();
    4370:	00002097          	auipc	ra,0x2
    4374:	81e080e7          	jalr	-2018(ra) # 5b8e <fork>
  if(pid < 0){
  ...
  if(pid == 0){
    ...
    438c:	84e080e7          	jalr	-1970(ra) # 5bd6 <open>
    if(fd >= 0){
    ...
    43ac:	7ee080e7          	jalr	2030(ra) # 5b96 <exit>
    ...
    43c8:	7d2080e7          	jalr	2002(ra) # 5b96 <exit>
    printf("%s: fork failed\n", s);
    43cc:	85a6                	mv	a1,s1
  ...
  if(unlink("oidir") != 0){
    ...
    4426:	774080e7          	jalr	1908(ra) # 5b96 <exit>
  wait(&xstatus);
    442a:	fdc40513          	addi	a0,s0,-36
    442e:	00001097          	auipc	ra,0x1
    4432:	770080e7          	jalr	1904(ra) # 5b9e <wait>
  exit(xstatus);
    4436:	fdc42503          	lw	a0,-36(s0)
    443a:	00001097          	auipc	ra,0x1
    443e:	75c080e7          	jalr	1884(ra) # 5b96 <exit>
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    445a:	790080e7          	jalr	1936(ra) # 5be6 <unlink>
  int pid = fork();
    445e:	00001097          	auipc	ra,0x1
    4462:	730080e7          	jalr	1840(ra) # 5b8e <fork>
  if(pid < 0){
  ...
  sleep(20); // two seconds
    ...
    4472:	7b8080e7          	jalr	1976(ra) # 5c26 <sleep>
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4486:	754080e7          	jalr	1876(ra) # 5bd6 <open>
    448a:	00001097          	auipc	ra,0x1
    448e:	734080e7          	jalr	1844(ra) # 5bbe <close>
  wait(0);
    4492:	4501                	li	a0,0
    4494:	00001097          	auipc	ra,0x1
    4498:	70a080e7          	jalr	1802(ra) # 5b9e <wait>
  sleep(10); // one second
    449c:	4529                	li	a0,10
    449e:	00001097          	auipc	ra,0x1
    44a2:	788080e7          	jalr	1928(ra) # 5c26 <sleep>
}
    ...
    44c8:	6d2080e7          	jalr	1746(ra) # 5b96 <exit>
    ...
    44dc:	6fe080e7          	jalr	1790(ra) # 5bd6 <open>
      if(fd >= 0){
    44e0:	02055763          	bgez	a0,450e <forkforkfork+0xcc>
      if(fork() < 0){
    44e4:	00001097          	auipc	ra,0x1
    44e8:	6aa080e7          	jalr	1706(ra) # 5b8e <fork>
    ...
    4500:	6da080e7          	jalr	1754(ra) # 5bd6 <open>
    4504:	00001097          	auipc	ra,0x1
    4508:	6ba080e7          	jalr	1722(ra) # 5bbe <close>
    450c:	b7e1                	j	44d4 <forkforkfork+0x92>
        exit(0);
    450e:	4501                	li	a0,0
    4510:	00001097          	auipc	ra,0x1
    4514:	686080e7          	jalr	1670(ra) # 5b96 <exit>
...
0000000000004518 <killstatus>:
{
    ...
    4534:	65e080e7          	jalr	1630(ra) # 5b8e <fork>
    4538:	84aa                	mv	s1,a0
    if(pid1 < 0){
    ...
    4546:	6e4080e7          	jalr	1764(ra) # 5c26 <sleep>
    kill(pid1);
    454a:	8526                	mv	a0,s1
    454c:	00001097          	auipc	ra,0x1
    4550:	67a080e7          	jalr	1658(ra) # 5bc6 <kill>
    wait(&xst);
    4554:	fcc40513          	addi	a0,s0,-52
    4558:	00001097          	auipc	ra,0x1
    455c:	646080e7          	jalr	1606(ra) # 5b9e <wait>
    if(xst != -1) {
  ...
  exit(0);
    ...
    4574:	626080e7          	jalr	1574(ra) # 5b96 <exit>
      printf("%s: fork failed\n", s);
    4578:	85d2                	mv	a1,s4
    ...
    4590:	60a080e7          	jalr	1546(ra) # 5b96 <exit>
        getpid();
    4594:	00001097          	auipc	ra,0x1
    4598:	682080e7          	jalr	1666(ra) # 5c16 <getpid>
      while(1) {
    ...
    45b6:	5e4080e7          	jalr	1508(ra) # 5b96 <exit>
...
00000000000045ba <preempt>:
{
  ...
  pid1 = fork();
    ...
    45d0:	5c2080e7          	jalr	1474(ra) # 5b8e <fork>
  if(pid1 < 0) {
  ...
  if(pid1 == 0)
    ...
    45f6:	5a4080e7          	jalr	1444(ra) # 5b96 <exit>
  pid2 = fork();
    45fa:	00001097          	auipc	ra,0x1
    45fe:	594080e7          	jalr	1428(ra) # 5b8e <fork>
    4602:	89aa                	mv	s3,a0
  if(pid2 < 0) {
  ...
  if(pid2 == 0)
    ...
    4624:	576080e7          	jalr	1398(ra) # 5b96 <exit>
  pipe(pfds);
    4628:	fc840513          	addi	a0,s0,-56
    462c:	00001097          	auipc	ra,0x1
    4630:	57a080e7          	jalr	1402(ra) # 5ba6 <pipe>
  pid3 = fork();
    4634:	00001097          	auipc	ra,0x1
    4638:	55a080e7          	jalr	1370(ra) # 5b8e <fork>
    463c:	8a2a                	mv	s4,a0
  if(pid3 < 0) {
  ...
  if(pid3 == 0){
    ...
    464c:	576080e7          	jalr	1398(ra) # 5bbe <close>
    ...
    4692:	508080e7          	jalr	1288(ra) # 5b96 <exit>
  ...
  close(pfds[1]);
    ...
    46b2:	510080e7          	jalr	1296(ra) # 5bbe <close>
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46c8:	4ea080e7          	jalr	1258(ra) # 5bae <read>
    46cc:	4785                	li	a5,1
  ...
  close(pfds[0]);
    ...
    46fc:	4c6080e7          	jalr	1222(ra) # 5bbe <close>
  printf("kill... ");
  ...
  kill(pid1);
    ...
    4716:	4b4080e7          	jalr	1204(ra) # 5bc6 <kill>
  kill(pid2);
    471a:	854e                	mv	a0,s3
    471c:	00001097          	auipc	ra,0x1
    4720:	4aa080e7          	jalr	1194(ra) # 5bc6 <kill>
  kill(pid3);
    4724:	8552                	mv	a0,s4
    4726:	00001097          	auipc	ra,0x1
    472a:	4a0080e7          	jalr	1184(ra) # 5bc6 <kill>
  printf("wait... ");
  ...
  wait(0);
    ...
    4744:	45e080e7          	jalr	1118(ra) # 5b9e <wait>
  wait(0);
    4748:	4501                	li	a0,0
    474a:	00001097          	auipc	ra,0x1
    474e:	454080e7          	jalr	1108(ra) # 5b9e <wait>
  wait(0);
    4752:	4501                	li	a0,0
    4754:	00001097          	auipc	ra,0x1
    4758:	44a080e7          	jalr	1098(ra) # 5b9e <wait>
...
000000000000475e <reparent>:
{
  ...
  int master_pid = getpid();
    ...
    4774:	4a6080e7          	jalr	1190(ra) # 5c16 <getpid>
    4778:	8a2a                	mv	s4,a0
    477a:	0c800913          	li	s2,200
    int pid = fork();
    477e:	00001097          	auipc	ra,0x1
    4782:	410080e7          	jalr	1040(ra) # 5b8e <fork>
    4786:	84aa                	mv	s1,a0
    if(pid < 0){
    ...
    4794:	40e080e7          	jalr	1038(ra) # 5b9e <wait>
  ...
  exit(0);
    ...
    47a8:	3f2080e7          	jalr	1010(ra) # 5b96 <exit>
      printf("%s: fork failed\n", s);
    47ac:	85ce                	mv	a1,s3
    ...
    47c4:	3d6080e7          	jalr	982(ra) # 5b96 <exit>
        printf("%s: wait wrong pid\n", s);
    47c8:	85ce                	mv	a1,s3
    ...
    47e0:	3ba080e7          	jalr	954(ra) # 5b96 <exit>
      int pid2 = fork();
    47e4:	00001097          	auipc	ra,0x1
    47e8:	3aa080e7          	jalr	938(ra) # 5b8e <fork>
      if(pid2 < 0){
    47ec:	00054763          	bltz	a0,47fa <reparent+0x9c>
      exit(0);
    47f0:	4501                	li	a0,0
    47f2:	00001097          	auipc	ra,0x1
    47f6:	3a4080e7          	jalr	932(ra) # 5b96 <exit>
        kill(master_pid);
    47fa:	8552                	mv	a0,s4
    47fc:	00001097          	auipc	ra,0x1
    4800:	3ca080e7          	jalr	970(ra) # 5bc6 <kill>
        exit(1);
    4804:	4505                	li	a0,1
    4806:	00001097          	auipc	ra,0x1
    480a:	390080e7          	jalr	912(ra) # 5b96 <exit>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    482a:	380080e7          	jalr	896(ra) # 5ba6 <pipe>
    ...
    4884:	336080e7          	jalr	822(ra) # 5bb6 <write>
      for(;;) sleep(1000);
    4888:	3e800513          	li	a0,1000
    488c:	00001097          	auipc	ra,0x1
    4890:	39a080e7          	jalr	922(ra) # 5c26 <sleep>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    48a0:	2f2080e7          	jalr	754(ra) # 5b8e <fork>
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    48e2:	2e8080e7          	jalr	744(ra) # 5bc6 <kill>
    wait(0);
    48e6:	4501                	li	a0,0
    48e8:	00001097          	auipc	ra,0x1
    48ec:	2b6080e7          	jalr	694(ra) # 5b9e <wait>
  ...
  pid = fork();
    ...
    48fc:	296080e7          	jalr	662(ra) # 5b8e <fork>
    4900:	84aa                	mv	s1,a0
  if(pid < 0){
  ...
  wait(&xstatus);
    ...
    4910:	292080e7          	jalr	658(ra) # 5b9e <wait>
  if(xstatus != -1 && xstatus != 2)
    ...
    494e:	24c080e7          	jalr	588(ra) # 5b96 <exit>
    printf("%s: fork failed\n", s);
    4952:	85d6                	mv	a1,s5
    ...
    496a:	230080e7          	jalr	560(ra) # 5b96 <exit>
    a = sbrk(0);
    496e:	4501                	li	a0,0
    4970:	00001097          	auipc	ra,0x1
    4974:	2ae080e7          	jalr	686(ra) # 5c1e <sbrk>
    4978:	892a                	mv	s2,a0
    sbrk(10*BIG);
    497a:	3e800537          	lui	a0,0x3e800
    497e:	00001097          	auipc	ra,0x1
    4982:	2a0080e7          	jalr	672(ra) # 5c1e <sbrk>
    ...
    49b6:	1e4080e7          	jalr	484(ra) # 5b96 <exit>
    exit(1);
    49ba:	4505                	li	a0,1
    49bc:	00001097          	auipc	ra,0x1
    49c0:	1da080e7          	jalr	474(ra) # 5b96 <exit>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    49d8:	1ba080e7          	jalr	442(ra) # 5b8e <fork>
    m1 = 0;
    49dc:	4481                	li	s1,0
  ...
  if((pid = fork()) == 0){
    ...
    49ee:	1b4080e7          	jalr	436(ra) # 5b9e <wait>
    if(xstatus == -1){
    ...
    4a00:	19a080e7          	jalr	410(ra) # 5b96 <exit>
      *(char**)m2 = m1;
    ...
    4a3e:	15c080e7          	jalr	348(ra) # 5b96 <exit>
    ...
    4a5a:	140080e7          	jalr	320(ra) # 5b96 <exit>
      exit(0);
    4a5e:	4501                	li	a0,0
    4a60:	00001097          	auipc	ra,0x1
    4a64:	136080e7          	jalr	310(ra) # 5b96 <exit>
...
0000000000004a68 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    4a8c:	15e080e7          	jalr	350(ra) # 5be6 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    ...
    4aa0:	13a080e7          	jalr	314(ra) # 5bd6 <open>
  if(fd < 0){
    4aa4:	04054a63          	bltz	a0,4af8 <sharedfd+0x90>
    4aa8:	892a                	mv	s2,a0
  pid = fork();
    4aaa:	00001097          	auipc	ra,0x1
    4aae:	0e4080e7          	jalr	228(ra) # 5b8e <fork>
    4ab2:	89aa                	mv	s3,a0
  memset(buf, pid==0?'c':'p', sizeof(buf));
    ...
    4adc:	0de080e7          	jalr	222(ra) # 5bb6 <write>
    4ae0:	47a9                	li	a5,10
  ...
  if(pid == 0) {
    ...
    4af4:	0a6080e7          	jalr	166(ra) # 5b96 <exit>
    ...
    4b10:	08a080e7          	jalr	138(ra) # 5b96 <exit>
    ...
    4b2c:	06e080e7          	jalr	110(ra) # 5b96 <exit>
    wait(&xstatus);
    4b30:	f9c40513          	addi	a0,s0,-100
    4b34:	00001097          	auipc	ra,0x1
    4b38:	06a080e7          	jalr	106(ra) # 5b9e <wait>
    if(xstatus != 0)
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b8a:	028080e7          	jalr	40(ra) # 5bae <read>
    ...
    4bb0:	fea080e7          	jalr	-22(ra) # 5b96 <exit>
        nc++;
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c12:	f88080e7          	jalr	-120(ra) # 5b96 <exit>
    exit(0);
    4c16:	4501                	li	a0,0
    4c18:	00001097          	auipc	ra,0x1
    4c1c:	f7e080e7          	jalr	-130(ra) # 5b96 <exit>
...
0000000000004c20 <fourfiles>:
{
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4c84:	f66080e7          	jalr	-154(ra) # 5be6 <unlink>
    pid = fork();
    4c88:	00001097          	auipc	ra,0x1
    4c8c:	f06080e7          	jalr	-250(ra) # 5b8e <fork>
    if(pid < 0){
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    4ca8:	efa080e7          	jalr	-262(ra) # 5b9e <wait>
    if(xstatus != 0)
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce8:	eb2080e7          	jalr	-334(ra) # 5b96 <exit>
      fd = open(fname, O_CREATE | O_RDWR);
    4cec:	20200593          	li	a1,514
    4cf0:	854e                	mv	a0,s3
    4cf2:	00001097          	auipc	ra,0x1
    4cf6:	ee4080e7          	jalr	-284(ra) # 5bd6 <open>
    4cfa:	892a                	mv	s2,a0
      if(fd < 0){
    ...
    4d2e:	e8c080e7          	jalr	-372(ra) # 5bb6 <write>
    4d32:	85aa                	mv	a1,a0
    ...
    4d46:	e54080e7          	jalr	-428(ra) # 5b96 <exit>
    ...
    4d62:	e38080e7          	jalr	-456(ra) # 5b96 <exit>
    ...
    4d7c:	e1e080e7          	jalr	-482(ra) # 5b96 <exit>
      exit(xstatus);
    4d80:	8556                	mv	a0,s5
    4d82:	00001097          	auipc	ra,0x1
    4d86:	e14080e7          	jalr	-492(ra) # 5b96 <exit>
          printf("wrong char\n", s);
    4d8a:	85e6                	mv	a1,s9
    ...
    4da2:	df8080e7          	jalr	-520(ra) # 5b96 <exit>
      total += n;
    ...
    4db4:	dfe080e7          	jalr	-514(ra) # 5bae <read>
    ...
    4dde:	de4080e7          	jalr	-540(ra) # 5bbe <close>
    if(total != N*SZ){
    4de2:	03a91863          	bne	s2,s10,4e12 <fourfiles+0x1f2>
    unlink(fname);
    4de6:	8562                	mv	a0,s8
    4de8:	00001097          	auipc	ra,0x1
    4dec:	dfe080e7          	jalr	-514(ra) # 5be6 <unlink>
  for(i = 0; i < NCHILD; i++){
    ...
    4e04:	dd6080e7          	jalr	-554(ra) # 5bd6 <open>
    4e08:	89aa                	mv	s3,a0
    total = 0;
    4e0a:	8956                	mv	s2,s5
        if(buf[j] != '0'+i){
    ...
    4e2a:	d70080e7          	jalr	-656(ra) # 5b96 <exit>
}
...
0000000000004e4c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e8e:	d6c080e7          	jalr	-660(ra) # 5bf6 <link>
    if(pid == 0) {
    ...
    4eac:	d2e080e7          	jalr	-722(ra) # 5bd6 <open>
      if(fd < 0){
    ...
    4ece:	ccc080e7          	jalr	-820(ra) # 5b96 <exit>
      link("C0", file);
    ...
    4ee2:	d18080e7          	jalr	-744(ra) # 5bf6 <link>
      exit(0);
    4ee6:	4501                	li	a0,0
    4ee8:	00001097          	auipc	ra,0x1
    4eec:	cae080e7          	jalr	-850(ra) # 5b96 <exit>
        exit(1);
    4ef0:	4505                	li	a0,1
    4ef2:	00001097          	auipc	ra,0x1
    4ef6:	ca4080e7          	jalr	-860(ra) # 5b96 <exit>
  ...
  fd = open(".", 0);
    ...
    4f1a:	cc0080e7          	jalr	-832(ra) # 5bd6 <open>
    4f1e:	892a                	mv	s2,a0
  n = 0;
    4f20:	8aa6                	mv	s5,s1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f38:	c7a080e7          	jalr	-902(ra) # 5bae <read>
    ...
    4f9c:	bfe080e7          	jalr	-1026(ra) # 5b96 <exit>
    ...
    4fbc:	bde080e7          	jalr	-1058(ra) # 5b96 <exit>
  close(fd);
    4fc0:	854a                	mv	a0,s2
    4fc2:	00001097          	auipc	ra,0x1
    4fc6:	bfc080e7          	jalr	-1028(ra) # 5bbe <close>
  if(n != N){
  ...
  for(i = 0; i < N; i++){
    ...
    4ff4:	ba6080e7          	jalr	-1114(ra) # 5b96 <exit>
      printf("%s: fork failed\n", s);
    4ff8:	85ce                	mv	a1,s3
  ...
  for(i = 0; i < N; i++){
    ...
    50b8:	ada080e7          	jalr	-1318(ra) # 5b8e <fork>
    50bc:	892a                	mv	s2,a0
    if(pid < 0){
  ...
  for(i = 0; i < N; i++){
    ...
    5164:	a86080e7          	jalr	-1402(ra) # 5be6 <unlink>
    pid = fork();
    5168:	00001097          	auipc	ra,0x1
    516c:	a26080e7          	jalr	-1498(ra) # 5b8e <fork>
    if(pid && (i % 3) == 1){
    ...
    5188:	a52080e7          	jalr	-1454(ra) # 5bd6 <open>
      if(fd < 0){
...
00000000000051a8 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    51c8:	a22080e7          	jalr	-1502(ra) # 5be6 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    ...
    51dc:	9fe080e7          	jalr	-1538(ra) # 5bd6 <open>
    51e0:	89aa                	mv	s3,a0
  for(i = 0; i < N; i++){
    51e2:	4481                	li	s1,0
    memset(buf, i, SZ);
  ...
  if(fd < 0){
    ...
    520e:	9ac080e7          	jalr	-1620(ra) # 5bb6 <write>
  ...
  if(fd < 0){
    ...
    525a:	958080e7          	jalr	-1704(ra) # 5bae <read>
    if(cc < 0){
  ...
  for(i = 0; ; i++){
    ...
    52a6:	8f4080e7          	jalr	-1804(ra) # 5b96 <exit>
    ...
    52c2:	8d8080e7          	jalr	-1832(ra) # 5b96 <exit>
    ...
    52de:	8bc080e7          	jalr	-1860(ra) # 5b96 <exit>
    ...
    52fa:	8a0080e7          	jalr	-1888(ra) # 5b96 <exit>
    ...
    5316:	884080e7          	jalr	-1916(ra) # 5b96 <exit>
    ...
    5332:	868080e7          	jalr	-1944(ra) # 5b96 <exit>
  close(fd);
    5336:	8552                	mv	a0,s4
    5338:	00001097          	auipc	ra,0x1
    533c:	886080e7          	jalr	-1914(ra) # 5bbe <close>
  if(total != N*SZ){
  ...
  unlink("bigfile.dat");
    ...
    5356:	894080e7          	jalr	-1900(ra) # 5be6 <unlink>
}
    ...
    5384:	816080e7          	jalr	-2026(ra) # 5b96 <exit>
...
0000000000005388 <fsfull>:
{
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    5426:	7b4080e7          	jalr	1972(ra) # 5bd6 <open>
    542a:	892a                	mv	s2,a0
    if(fd < 0){
  ...
  while(nfiles >= 0){
    ...
    54a0:	74a080e7          	jalr	1866(ra) # 5be6 <unlink>
    nfiles--;
  ...
  printf("fsfull test finished\n");
    ...
    54f0:	6ca080e7          	jalr	1738(ra) # 5bb6 <write>
      if(cc < BSIZE)
    ...
    5516:	6ac080e7          	jalr	1708(ra) # 5bbe <close>
    if(total == 0)
...
run(void f(char *), char *s) {
  ...
  if((pid = fork()) < 0) {
    ...
    5546:	64c080e7          	jalr	1612(ra) # 5b8e <fork>
  ...
  if(pid == 0) {
    ...
    5558:	64a080e7          	jalr	1610(ra) # 5b9e <wait>
    if(xstatus != 0) 
    ...
    559c:	5fe080e7          	jalr	1534(ra) # 5b96 <exit>
    f(s);
    55a0:	854a                	mv	a0,s2
    55a2:	9482                	jalr	s1
    exit(0);
    ...
    55aa:	5f0080e7          	jalr	1520(ra) # 5b96 <exit>
      printf("OK\n");
...
countfree()
{
  ...
  if(pipe(fds) < 0){
    ...
    5632:	578080e7          	jalr	1400(ra) # 5ba6 <pipe>
  ...
  int pid = fork();
    ...
    563e:	554080e7          	jalr	1364(ra) # 5b8e <fork>
  ...
  if(pid == 0){
    ...
    5650:	572080e7          	jalr	1394(ra) # 5bbe <close>
    ...
    5666:	5bc080e7          	jalr	1468(ra) # 5c1e <sbrk>
      if(a == 0xffffffffffffffff){
    ...
    5682:	538080e7          	jalr	1336(ra) # 5bb6 <write>
    ...
    56a0:	4fa080e7          	jalr	1274(ra) # 5b96 <exit>
    printf("pipe() failed in countfree()\n");
    ...
    56ba:	4e0080e7          	jalr	1248(ra) # 5b96 <exit>
    printf("fork failed in countfree()\n");
    ...
    56d4:	4c6080e7          	jalr	1222(ra) # 5b96 <exit>
      }
    }
    ...
    56de:	4bc080e7          	jalr	1212(ra) # 5b96 <exit>
  }

  close(fds[1]);
    56e2:	fcc42503          	lw	a0,-52(s0)
    56e6:	00000097          	auipc	ra,0x0
    56ea:	4d8080e7          	jalr	1240(ra) # 5bbe <close>
  ...
  while(1){
    ...
    56fe:	4b4080e7          	jalr	1204(ra) # 5bae <read>
    if(cc < 0){
  ...
  while(1){
    ...
    5722:	478080e7          	jalr	1144(ra) # 5b96 <exit>
  }

  close(fds[0]);
    5726:	fc842503          	lw	a0,-56(s0)
    572a:	00000097          	auipc	ra,0x0
    572e:	494080e7          	jalr	1172(ra) # 5bbe <close>
  wait((int*)0);
    5732:	4501                	li	a0,0
    5734:	00000097          	auipc	ra,0x0
    5738:	46a080e7          	jalr	1130(ra) # 5b9e <wait>
...
main(int argc, char *argv[])
{
  ...
  if (drivetests(quick, continuous, justone)) {
    ...
    5862:	338080e7          	jalr	824(ra) # 5b96 <exit>
    5866:	892e                	mv	s2,a1
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
  ...
  int continuous = 0;
    ...
    58de:	2bc080e7          	jalr	700(ra) # 5b96 <exit>
  char *justone = 0;
    58e2:	4601                	li	a2,0
    continuous = 1;
    58e4:	4585                	li	a1,1
  ...
  exit(0);
    ...
    5904:	296080e7          	jalr	662(ra) # 5b96 <exit>
...
_main()
{
  ...
  exit(0);
    ...
    591e:	27c080e7          	jalr	636(ra) # 5b96 <exit>
...
gets(char *buf, int max)
{
  ...
  for(i=0; i+1 < max; ){
    ...
    5a10:	1a2080e7          	jalr	418(ra) # 5bae <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
  ...
  fd = open(n, O_RDONLY);
    ...
    5a62:	178080e7          	jalr	376(ra) # 5bd6 <open>
  if(fd < 0)
  ...
  r = fstat(fd, st);
    ...
    5a72:	180080e7          	jalr	384(ra) # 5bee <fstat>
    5a76:	892a                	mv	s2,a0
  close(fd);
    5a78:	8526                	mv	a0,s1
    5a7a:	00000097          	auipc	ra,0x0
    5a7e:	144080e7          	jalr	324(ra) # 5bbe <close>
  return r;
}
    5a82:	854a                	mv	a0,s2
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5c4c:	f6e080e7          	jalr	-146(ra) # 5bb6 <write>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    6090:	b92080e7          	jalr	-1134(ra) # 5c1e <sbrk>
  if(p == (char*)-1)
