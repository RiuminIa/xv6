...
_main()
{
  ...
  40:	27c080e7          	jalr	636(ra) # 2b8 <exit>
...
gets(char *buf, int max)
{
 ...
 132:	1a2080e7          	jalr	418(ra) # 2d0 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 184:	178080e7          	jalr	376(ra) # 2f8 <open>
  if(fd < 0)
 ...
 194:	180080e7          	jalr	384(ra) # 310 <fstat>
 198:	892a                	mv	s2,a0
  close(fd);
 19a:	8526                	mv	a0,s1
 19c:	00000097          	auipc	ra,0x0
 1a0:	144080e7          	jalr	324(ra) # 2e0 <close>
  return r;
}
 1a4:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 7b2:	b92080e7          	jalr	-1134(ra) # 340 <sbrk>
  if(p == (char*)-1)
