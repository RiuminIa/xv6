...
_main()
{
 ...
 132:	27c080e7          	jalr	636(ra) # 3aa <exit>
...
gets(char *buf, int max)
{
 ...
 224:	1a2080e7          	jalr	418(ra) # 3c2 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 276:	178080e7          	jalr	376(ra) # 3ea <open>
  if(fd < 0)
 ...
 286:	180080e7          	jalr	384(ra) # 402 <fstat>
 28a:	892a                	mv	s2,a0
  close(fd);
 28c:	8526                	mv	a0,s1
 28e:	00000097          	auipc	ra,0x0
 292:	144080e7          	jalr	324(ra) # 3d2 <close>
  return r;
}
 296:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 8a4:	b92080e7          	jalr	-1134(ra) # 432 <sbrk>
  if(p == (char*)-1)
