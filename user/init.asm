...
_main()
{
 ...
 10e:	27c080e7          	jalr	636(ra) # 386 <exit>
...
gets(char *buf, int max)
{
 ...
 200:	1a2080e7          	jalr	418(ra) # 39e <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 252:	178080e7          	jalr	376(ra) # 3c6 <open>
  if(fd < 0)
 ...
 262:	180080e7          	jalr	384(ra) # 3de <fstat>
 266:	892a                	mv	s2,a0
  close(fd);
 268:	8526                	mv	a0,s1
 26a:	00000097          	auipc	ra,0x0
 26e:	144080e7          	jalr	324(ra) # 3ae <close>
  return r;
}
 272:	854a                	mv	a0,s2
...
malloc(uint nbytes)
{
 ...
 880:	b92080e7          	jalr	-1134(ra) # 40e <sbrk>
  if(p == (char*)-1)
