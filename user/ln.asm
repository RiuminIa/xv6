...
main(int argc, char *argv[])
{
  ...
  28:	2ca080e7          	jalr	714(ra) # 2ee <exit>
  2c:	84ae                	mv	s1,a1
  }
  ...
  36:	31c080e7          	jalr	796(ra) # 34e <link>
...
_main()
{
  ...
  76:	27c080e7          	jalr	636(ra) # 2ee <exit>
...
gets(char *buf, int max)
{
 ...
 168:	1a2080e7          	jalr	418(ra) # 306 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 1ba:	178080e7          	jalr	376(ra) # 32e <open>
  if(fd < 0)
 ...
 1ca:	180080e7          	jalr	384(ra) # 346 <fstat>
 1ce:	892a                	mv	s2,a0
  close(fd);
 1d0:	8526                	mv	a0,s1
 1d2:	00000097          	auipc	ra,0x0
 1d6:	144080e7          	jalr	324(ra) # 316 <close>
  return r;
}
 1da:	854a                	mv	a0,s2
